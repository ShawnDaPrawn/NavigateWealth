...
**Environment:** client intake UI enabled, Edge Function deployed, Postgres migration applied, \`FNA_INTAKE_READ_FROM=postgres\` after backfill.
...
- [x] Published-result parity: \`ClientFNAHub\` routes published status to legacy \`ClientFNAView\`

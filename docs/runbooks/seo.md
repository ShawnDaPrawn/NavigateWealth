...
| Page titles/descriptions (prerendered)    | `scripts/seo/seo-static-data.mjs` (`publicSeoRoutes`) — a parity test fails if titles drift from the client config |
| Organization / business facts             | `src/components/seo/organization.json`                                                                             |
| FAQ content                               | `src/components/seo/faqs.json`                                                                                     |
| Sitemap + robots                          | generated by `scripts/seo/generate-seo-files.mjs` at build                                                         |
| Prerendered heads + visible static bodies | `scripts/seo/apply-static-seo.mjs`                                                                                 |
| Build-time SEO assertions (hard gate)     | `scripts/seo/verify-seo-build.mjs`                                                                                 |
...
| Social/OG image (1200×630)                | `public/brand-assets/navigate-wealth-og.png`, regenerate with `node ./scripts/seo/generate-og-image.mjs`           |

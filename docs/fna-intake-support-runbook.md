...
| Client cannot see intake UI | Frontend deploy or batch-status issue | Hard refresh, verify latest frontend deploy, and inspect `/fna/batch-status/client/:clientId` |

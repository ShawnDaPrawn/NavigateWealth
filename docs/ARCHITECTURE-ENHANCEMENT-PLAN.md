...
| --- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | ------------------------------------- | --- | ------ |
| F1  | **Real module boundaries** — fix dependency-cruiser's resolver so first-party TS resolves, then the 3 boundary rules actually fire | §2.2, §2.4 module isolation    | **Vacuous** — 49/52 deps unresolved   |

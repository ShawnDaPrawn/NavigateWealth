...
- Client-led intake UI is launched by default: hub, queue, and intake CTAs are no longer behind a browser rollout flag
...
- [x] Client-led intake UI enabled in the production frontend (deployed 2026-05-23)

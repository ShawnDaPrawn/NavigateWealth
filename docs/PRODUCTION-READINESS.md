...
- Client intake hub, queue, and CTAs are launched and rendered by default
...
**Production launch:** UAT sign-off + legal consent + Postgres cutover are complete — see launch checklist.
...
- [x] Production client intake UI deployed on Vercel (2026-05-23)

...
- Client intake hub, queue, and intake CTAs are now the default launched path
...
**Production launch:** UAT sign-off, legal consent, Postgres cutover, and frontend launch are complete — see launch checklist.
...
- [x] Production client intake UI launched on Vercel (deployed 2026-05-23)

...
- Client-led FNA intake UI is launched and always on; hub, queue, and intake CTAs are no longer gated by a frontend rollout flag
...
- [x] Production client-led intake UI launched on Vercel (deployed 2026-05-23)

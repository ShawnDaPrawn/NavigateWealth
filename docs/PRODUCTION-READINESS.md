...
- Hub, queue, and intake CTAs are launched; the former `VITE_FNA_INTAKE_ENABLED` frontend gate has been removed
...
**Production launch:** Completed after UAT sign-off, legal consent verification, and Postgres cutover — see launch checklist.
...
- [x] Production frontend launched with intake hub, wizard, and queue (deployed 2026-05-23)

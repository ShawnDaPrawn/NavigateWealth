...
- [ ] Backup, DR, POPIA, FAIS, error-monitoring, CSP, and environment-split
      ...
      - [ ] **DR** — the mechanism is BUILT AND UNPROVEN, and it is unchecked
            ...
            `scripts/compare-restore.py` holds those rules and was exercised

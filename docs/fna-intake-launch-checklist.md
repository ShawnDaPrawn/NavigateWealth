...
2. [x] Client intake hub, queue, and CTAs deployed to production (all-at-once rollout)
...
1. Revert the frontend deploy that introduced a regression
2. Intake API remains available during rollback; no data loss if Postgres remains canonical

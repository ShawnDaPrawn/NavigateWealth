...
2. [x] Client intake UI is launched in production (all-at-once rollout)
...
1. Revert the launch commit and redeploy frontend — clients fall back to `ClientFNAView` for published results

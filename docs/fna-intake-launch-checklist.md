...
2. [x] Client-led intake UI launched on production (all-at-once rollout)
...
1. Revert the frontend launch commit and redeploy from `main`
2. Clients fall back to `ClientFNAView` for published results

...
export const FORM_FIELD_REGISTRY: Record<FormPrefillId, FormFieldMapping[]> = {
  ...
  'risk-fna-step1': [
    ...
    { formField: 'employmentType', label: 'Employment type', canonicalKey: 'profile_employment_type', group: 'Profile' },
    { formField: 'totalHouseholdMonthlyExpenditure', label: 'Household monthly expenditure', canonicalKey: 'profile_monthly_expenses', group: 'Financial' },
    { formField: 'dependantCount', label: 'Number of dependants', canonicalKey: 'derived:dependant_count', group: 'Profile' },
  ],
  'medical-fna-step1': [
    { formField: 'currentAge', label: 'Client age', canonicalKey: 'derived:age_from_dob', group: 'Profile' },
    { formField: 'spousePartner', label: 'Spouse / partner on cover', canonicalKey: 'derived:has_spouse', group: 'Profile' },
    { formField: 'childrenCount', label: 'Number of children', canonicalKey: 'derived:dependant_count_children', group: 'Profile' },
    { formField: 'grossMonthlyIncome', label: 'Gross monthly income', canonicalKey: 'profile_gross_monthly_income', group: 'Income' },
    { formField: 'existingPlanType', label: 'Existing plan type', canonicalKey: 'medical_aid_plan_type', group: 'Existing cover' },
    { formField: 'existingTotalPremium', label: 'Existing total premium', canonicalKey: 'medical_aid_total_premium', group: 'Existing cover' },
    { formField: 'existingMSA', label: 'Existing MSA', canonicalKey: 'medical_aid_msa', group: 'Existing cover' },
    { formField: 'existingLJP', label: 'Late joiner penalty', canonicalKey: 'medical_aid_late_joiner_penalty', group: 'Existing cover' },
    { formField: 'existingDependents', label: 'Existing dependants on policy', canonicalKey: 'medical_aid_dependents', group: 'Existing cover' },
    { formField: 'existingHospitalCover', label: 'Existing hospital cover', canonicalKey: 'medical_aid_hospital_tariff', group: 'Existing cover' },
  ],
  'tax-fna-step1': [
  ...
  'estate-fna-step1': [
    ...
    { formField: 'familyInfo.age', label: 'Age', canonicalKey: 'derived:age_from_dob', group: 'Family' },
  ],
  'investment-ina-step1': [
    ...
    { formField: 'fullName', label: 'Full name', canonicalKey: 'derived:full_name', group: 'Profile' },
    { formField: 'maritalStatus', label: 'Marital status', canonicalKey: 'profile_marital_status', group: 'Profile' },
    { formField: 'clientRiskProfile', label: 'Risk tolerance', canonicalKey: 'profile_risk_tolerance', group: 'Profile' },
    { formField: 'investmentHorizonYears', label: 'Investment horizon (years)', canonicalKey: 'profile_investment_horizon', group: 'Profile' },
  ],
};

...
export const DEFAULT_SCHEMAS: Record<string, unknown> = {
  risk_planning: {
    fields: [
      ...
      },
      {
        ...
        type: 'currency',
        required: false,
        keyId: 'risk_severe_illness',
      },
      {
        id: 'rp_4',
        name: 'Capital Disability',
        type: 'currency',
        required: false,
        keyId: 'risk_disability',
      },
      {
        id: 'rp_5',
  ...
  medical_aid: {
    fields: [
      { id: 'ma_1', name: 'Policy Number', type: 'text', required: true },
      {
        ...
        type: 'date',
        required: false,
        keyId: 'medical_aid_date_of_inception',
      },
      ...
      { id: 'ma_5', name: 'Hospital Benefit', type: 'text', required: false },
      {
        ...
        type: 'currency',
        required: false,
        keyId: 'medical_aid_msa',
      },
      {
        id: 'ma_9',
        name: 'Late Joiner Penalty (LPJ)',
        type: 'currency',
        required: false,
        keyId: 'medical_aid_late_joiner_penalty',
      },
      {
        id: 'ma_10',
        ...
        type: 'text',
        required: false,
        keyId: 'medical_aid_hospital_tariff',
      },
      {
        id: 'ma_6',
        name: 'Premium',
        type: 'currency',
        required: true,
        keyId: 'medical_aid_monthly_premium',
      },
  ...
  retirement_post: {
    fields: [
      ...
      {
        id: 'ret_post_inception',
        name: 'Date of Inception',
        type: 'date',
        required: false,
        keyId: 'post_retirement_date_of_inception',
      },
      {
        id: 'ret_post_2',
        name: 'Product Type',
  ...
  investments_guaranteed: {
    fields: [
      ...
      {
        id: 'inv_gua_inception',
        name: 'Date of Inception',
        type: 'date',
        required: false,
        keyId: 'invest_guaranteed_date_of_inception',
      },
      {
        id: 'inv_gua_2',
        name: 'Product Type',
  ...
  employee_benefits_risk: {
    fields: [
      ...
      {
        id: 'eb_risk_inception',
        name: 'Date of Inception',
        type: 'date',
        required: false,
        keyId: 'eb_risk_date_of_inception',
      },
      { id: 'eb_risk_2', name: 'Employer', type: 'text', required: true },
      {
        ...
        keyId: 'risk_product_type',
      }, // Maybe map to a risk key or EB key?
      {
        id: 'eb_risk_4',
        name: 'Life Cover',
        type: 'currency',
  ...
  employee_benefits_retirement: {
    fields: [
      { id: 'eb_ret_1', name: 'Policy Number', type: 'text', required: true },
      {
        ...
        type: 'date',
        required: false,
        keyId: 'eb_retirement_date_of_inception',
      },
      { id: 'eb_ret_2', name: 'Employer', type: 'text', required: true },
      {
        ...
        type: 'dropdown',
        required: true,
        options: ['Pension Fund', 'Provident Fund', 'Umbrella Fund'],
      },
      {
        id: 'eb_ret_4',
        name: 'Fund Value',
        type: 'currency',
        required: false,
        keyId: 'eb_pension_fund_value',
      }, // Or Provident, depending on type, but default schema picks one
      {
        id: 'eb_ret_5',
        name: 'Employee Contribution',
        type: 'currency',
        required: false,
        keyId: 'eb_retirement_contribution_employee',
      },
      {
        id: 'eb_ret_6',
        ...
        type: 'currency',
        required: false,
        keyId: 'eb_retirement_contribution_employer',
      },
  ...
  estate_planning: {
    fields: [
      { id: 'est_1', name: 'Policy Number', type: 'text', required: true },
      {
        ...
        type: 'date',
        required: false,
        keyId: 'estate_date_of_inception',
      },

 ...
 * Mounts the focused sub-routers extracted from the original 1,923-line file,
 * plus the navigator agent routes.
 */
...
import agentRoutes from './integrations-portal-agent-routes.ts';
...
portalRoutes.route('/', agentRoutes);

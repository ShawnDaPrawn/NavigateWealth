...
export const LocationTypeSchema = z.enum(['in_person', 'video', 'phone', 'virtual', 'other'] as [
  LocationType,
  ...LocationType[],
]);

export const EventStatusSchema = z.enum(['scheduled', 'completed', 'cancelled', 'rescheduled'] as [
  EventStatus,
  ...EventStatus[],
]);
...
export const ReminderPrioritySchema = z.enum(['low', 'normal', 'medium', 'high', 'urgent'] as [
  ReminderPriority,
  ...ReminderPriority[],
]);

export const ReminderStatusSchema = z.enum(['pending', 'completed', 'overdue', 'dismissed'] as [
  ReminderStatus,
  ...ReminderStatus[],
]);

 ...
 * social-assets-routes.ts. Per-channel media lives in social-channel-assets-
 * routes.ts (`/social-library`), which an outside agent also calls.
 * See docs/runbooks/social-automation.md.
 */

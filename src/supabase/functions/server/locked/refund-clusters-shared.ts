/**
 * Refund Clusters — shared helpers
 *
 * Constants and helpers shared by the refund-clusters route modules
 * (clusters/entities/documents and transactions). Keeping them here lets each
 * route file stay small, which keeps the edge-function bundle within the
 * deploy bundler's per-module limits.
 */

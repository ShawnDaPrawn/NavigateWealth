...
// --- Provider / Config / Template routes (extracted to integrations-provider-routes.ts) ---
app.route('/', providerRoutes);

// --- Portal automation routes (extracted to integrations-portal-routes.ts) ---
app.route('/', portalRoutes);

// --- Upload / History / Sync-run routes (extracted to integrations-upload-routes.ts) ---
app.route('/', uploadRoutes);

// --- Schema / Custom-key routes (extracted to integrations-schema-routes.ts) ---
app.route('/', schemaRoutes);

// --- Policy management routes (extracted to integrations-policy-routes.ts) ---
app.route('/', policyRoutes);

// --- Policy document routes (extracted to integrations-policy-documents-routes.ts) ---

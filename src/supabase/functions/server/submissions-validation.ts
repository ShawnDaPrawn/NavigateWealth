...
export const CreateSubmissionSchema = z.object({
  ...
  payload: z
    ...
    .refine((val) => val !== null && typeof val === 'object', 'Payload must be a non-null object'),
  submitterName: z
    .string()
    .max(200)
    .optional()
  ...
  submitterEmail: z
    .string()
    .email('Invalid submitter email format')
    .optional()
...
export const InviteEmailSchema = z.object({
  recipientEmail: z
    .string()
    .email('Recipient email is required and must be valid')
    .transform((v) => v.trim().toLowerCase()),
  recipientName: z
    .string()
    .max(200)

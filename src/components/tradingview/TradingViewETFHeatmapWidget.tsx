  ...
  useEffect(() => {
    ...
    if (el) {
      ...
      copyrightDiv.innerHTML = `
        <a href="https://www.tradingview.com/markets/etfs/" rel="noopener nofollow" target="_blank">
          <span class="blue-text">ETF heatmap by TradingView</span>
        </a>
      `;
    ...
    return (
      <div className="flex items-center justify-center h-[600px] bg-gray-50 rounded-lg border border-gray-200">
        <div className="text-center space-y-3">
          <p className="text-sm text-gray-600">ETF heatmap temporarily unavailable</p>

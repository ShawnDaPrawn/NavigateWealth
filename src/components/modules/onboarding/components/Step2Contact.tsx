    ...
    <div className="space-y-10">
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <Label htmlFor="alternativeEmail" className={LABEL_CLASS}>
                Alternative Email
              </Label>
              <Input
                id="alternativeEmail"
                ...
                onChange={(e) => updateData('alternativeEmail', e.target.value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="cellphoneNumber" className={LABEL_CLASS}>
              ...
              <Input
                ...
                onChange={(e) => updateData('cellphoneNumber', e.target.value)}
                placeholder="+27 82 123 4567"
                className={INPUT_CLASS}
              />
            </div>
            <div>
              <Label htmlFor="alternativeCellphone" className={LABEL_CLASS}>
                Alternative Cellphone
              </Label>
              <Input
                id="alternativeCellphone"
                type="tel"
                value={data.alternativeCellphone}
                onChange={(e) => updateData('alternativeCellphone', e.target.value)}
                placeholder="Optional"
                className={INPUT_CLASS}
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <Input
                ...
                placeholder="If different from cellphone"
                className={INPUT_CLASS}
              />
            </div>
          </div>
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="preferredContactMethod" className={LABEL_CLASS}>
            ...
            <div>
              <Label htmlFor="bestTimeToContact" className={LABEL_CLASS}>
                Best Time to Contact
              </Label>
              <Select
                value={data.bestTimeToContact}
                onValueChange={(value) => updateData('bestTimeToContact', value)}
              >
                <SelectTrigger id="bestTimeToContact" className={SELECT_TRIGGER_CLASS}>
                  <SelectValue placeholder="Select" />
                </SelectTrigger>
                <SelectContent>
                  {BEST_TIMES_TO_CONTACT.map((t) => (
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          ...
          <div>
            <Label htmlFor="residentialCountry" className={LABEL_CLASS}>
            ...
            {!isSouthAfrica && data.residentialCountry && (
              <div className="mt-2 flex items-center gap-1.5 text-xs text-blue-600 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2">
                ...
                <span>
                  International address format — please enter your address as it appears locally.
                </span>
              </div>
            )}
          </div>
          ...
          <div>
            <Label htmlFor="residentialAddressLine1" className={LABEL_CLASS}>
              Address Line 1 <span className="text-red-500">*</span>
            </Label>
            <Input
              id="residentialAddressLine1"
              value={data.residentialAddressLine1}
              onChange={(e) => updateData('residentialAddressLine1', e.target.value)}
          ...
          <div>
            <Label htmlFor="residentialAddressLine2" className={LABEL_CLASS}>
              Address Line 2
            </Label>
            <Input
              id="residentialAddressLine2"
              value={data.residentialAddressLine2}
              onChange={(e) => updateData('residentialAddressLine2', e.target.value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="residentialSuburb" className={LABEL_CLASS}>
                {isSouthAfrica ? 'Suburb' : 'Suburb / District'}
              </Label>
              <Input
                id="residentialSuburb"
                value={data.residentialSuburb}
                onChange={(e) => updateData('residentialSuburb', e.target.value)}
                className={INPUT_CLASS}
              />
            </div>
            <div>
              <Label htmlFor="residentialCity" className={LABEL_CLASS}>
                {cityLabel} <span className="text-red-500">*</span>
              </Label>
              <Input
                id="residentialCity"
                value={data.residentialCity}
                onChange={(e) => updateData('residentialCity', e.target.value)}
                className={INPUT_CLASS}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="residentialProvince" className={LABEL_CLASS}>
                {provinceLabel} <span className="text-red-500">*</span>
              </Label>
              {isSouthAfrica ? (
                <Select
                  value={data.residentialProvince}
                  onValueChange={(value) => updateData('residentialProvince', value)}
                >
                ...
                <Input
                  ...
                  value={data.residentialProvince}
                  onChange={(e) => updateData('residentialProvince', e.target.value)}
            ...
            <div>
              <Label htmlFor="residentialPostalCode" className={LABEL_CLASS}>
                {postalCodeLabel} <span className="text-red-500">*</span>
              </Label>
              <Input
                id="residentialPostalCode"
                value={data.residentialPostalCode}
                onChange={(e) => updateData('residentialPostalCode', e.target.value)}
                placeholder={isSouthAfrica ? 'e.g. 2196' : 'e.g. 10001, SW1A 1AA'}
                className={INPUT_CLASS}
              />
            </div>
          </div>

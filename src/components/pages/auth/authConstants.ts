 ...
 * Single source of truth for stats and feature showcases.
 */
...
export const LOGIN_FEATURES = [
  {
    ...
    description:
      'Monitor your investments, see live performance, and track progress against your goals.',
  },
  {
    iconSlug: 'Shield',
    title: 'Enterprise-Grade Security',
    description:
      'Two-factor authentication, encryption at rest, and full POPIA compliance protect your data.',
  },
  {
    iconSlug: 'Users',
    title: 'Dedicated Advisor Access',
    description:
      'Connect directly with your personal financial advisor for guidance whenever you need it.',
  },
] as const;
...
export const SIGNUP_FEATURES = [
  {
    ...
    description:
      'Receive a personalised strategy built around your income, goals, and risk appetite.',
  },
  {
    iconSlug: 'Shield',
  ...
  },
  {
    ...
    description:
      'A qualified advisor is assigned to you and available throughout your financial journey.',
  },
] as const;

...
const services = [
  {
    ...
    description:
      "Access South Africa's leading medical schemes and products with comprehensive gap cover protection.",
    icon: Heart,
    link: '/medical-aid',
  ...
  },
  {
    ...
    description:
      'Protecting your income and your loved ones with comprehensive risk management solutions.',
    icon: Shield,
  ...
  },
  {
    ...
    description:
      'Build a future you can count on with proven investment platforms and retirement strategies.',
    icon: Trophy,
  ...
  },
  {
    ...
    description:
      'Diversify your wealth and hedge against rand depreciation with local and international investments.',
    icon: TrendingUp,
  ...
  },
  {
    title: 'Tax Planning',
    description:
      'Optimize your tax strategy and minimize liability through expert planning and compliance.',
    icon: DollarSign,
    link: '/tax-planning',
...
const digitalFeatures = [
  {
    icon: Smartphone,
    title: 'Mobile Access',
    description: 'Manage your finances on the go from any device',
  },
  {
    icon: Monitor,
    title: 'Client Portal',
    description: 'View all policies, statements and documents in one place',
  },
  {
    icon: FileText,
    title: 'Document Access',
    description: 'Download and sign documents instantly — no paperwork',
  },
  {
    icon: HeadphonesIcon,
    title: 'Personal Support',
    description: 'Real human advice from a dedicated financial adviser',
  },
];
...
export function ForIndividualsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        {...getSEOData('for-individuals')}
        structuredData={createWebPageSchema(
          getSEOData('for-individuals').title,
          getSEOData('for-individuals').description,
          getSEOData('for-individuals').canonicalUrl,
        )}
      />
          ...
          <div className="flex flex-col items-center text-center py-20 lg:py-28">
            ...
            <div className="max-w-3xl space-y-5">
              ...
              <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                We help you make smart, confident financial decisions — whether you're starting out,
                growing your career, protecting your family, or planning for retirement.
              </p>
            </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                Life comes with milestones — first job, first home, marriage, children, and
                eventually retirement. At each stage, your financial needs evolve. We partner with
                you for the long term, helping you adapt your plan as your life changes. Our
                independence means we're not tied to one provider, so you get the best product fit
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              Our clients benefit from Navigate Wealth's scale and experience. These numbers mean we
              have negotiating power with providers, while you still receive the personalised
              attention of a boutique, independent adviser.
            </p>
            <div className="pt-4">
              <Button
                size="lg"
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                Navigate Wealth combines a state-of-the-art digital platform with the reassurance of
                real-world advice. Through your online client portal you can view policies, access
                documents, and communicate with us anytime, anywhere.
              </p>
              <p className="text-gray-500 leading-relaxed">
                Behind the tech, we're real people who take the time to understand you and guide you
                — because great financial advice is both smart and personal.
              </p>
            </div>
      ...
      <section className="bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              Whether you're just starting out or planning for retirement, we're here to help you
              make smart, confident financial decisions every step of the way.
            </p>

...
const individualProducts: Record<string, CoverContent> = {
  'life-cover': {
    ...
    benefitsDescription:
      "Life cover provides essential financial security for your family by ensuring they can maintain their standard of living, pay off outstanding debts, and secure their future even when you're no longer there to provide for them.",
    features: [
      { title: 'Death Benefit', description: 'Lump-sum payout to beneficiaries' },
      {
        title: 'Terminal Illness',
        description: 'Advanced payment if diagnosed with terminal illness',
      },
    ...
    benefits: [
      ...
      'Coverage from R100,000 to R50 million',
      'Premium can remain level for life',
  ...
  disability: {
    ...
    benefitsDescription:
      'Capital Disability cover provides a comprehensive lump-sum payout when permanent disability prevents you from working. This single payment gives you immediate access to significant funds to restructure your life, pay off debts, and adapt your living environment.',
    features: [
      ...
      { title: 'Functional Disability', description: 'Based on loss of specific functions' },
      {
        ...
        description: 'Enhanced payout for total and permanent disability',
      },
    ],
    benefits: [
      'Up to 75% of annual income as lump sum',
  ...
  'severe-illness': {
    ...
    benefitsDescription:
      "Severe illness cover provides vital financial support when you're diagnosed with a major medical condition, allowing you to focus entirely on your recovery without financial stress. This ensures you have access to the best possible care.",
    features: [
    ...
    benefits: [
      ...
      'Option for buy-back cover after a claim',
    ],
  ...
  'income-protection': {
    ...
    benefitsDescription:
      'Income protection acts as a financial safety net, providing regular monthly payments when illness or injury prevents you from working. This ensures you can continue to meet your financial obligations and maintain your lifestyle.',
    features: [
    ...
    benefits: [
      'Up to 75% of gross monthly income',
      'Inflation-linked increases available',
      'Covers illness and accidental injury',
      'Return to work incentives included',
    ],
  ...
  'other-benefits': {
    ...
    benefitsDescription:
      'Additional benefits provide comprehensive protection beyond basic coverage, ensuring you and your family are protected against a wide range of unexpected events. These supplementary benefits offer immediate financial assistance for specific situations.',
    features: [
    ...
    benefits: [
      'Guaranteed insurability at life events',
      'No medical questions for increases',
      'Immediate access to funeral funds',
      'Peace of mind for education costs',
    ],
...
const businessProducts: Record<string, CoverContent> = {
  'buy-sell': {
    ...
    description:
      'Ensures smooth transfer of ownership on death or disability of a business partner.',
    benefitsDescription:
      "Buy & Sell agreements provide essential business continuity protection by ensuring that surviving partners can acquire the deceased partner's share without financial strain. This coverage eliminates potential disputes and protects the business from external parties gaining unwanted control.",
    features: [
      {
        title: 'Ownership Transfer',
        description: 'Funded transfer of shares on death or disability',
      },
    ...
    benefits: [
      'Automatic valuation and transfer process',
      'Prevents external parties gaining control',
      'Immediate funds for share purchase',
      "Protects surviving partners' interests",
  ...
  'key-person': {
    ...
    description:
      'Covers financial loss from death or disability of a key employee or business owner.',
    benefitsDescription:
      'Key Person insurance recognises that certain individuals are critical to your business success. When these key people are unable to work, this coverage compensates your business for lost revenue, recruitment costs, and training expenses, maintaining operational stability.',
    features: [
    ...
    benefits: [
      'Compensation for lost revenue and profits',
      'Funds for recruitment and training costs',
      'Protection against business loan defaults',
  ...
  'contingent-liability': {
    ...
    benefitsDescription:
      'Contingent Liability cover protects your business and remaining owners from inherited financial obligations when a business owner or guarantor dies, ensuring that business debts and loans are settled without threatening operations.',
    features: [
    ...
    benefits: [
      'Automatic settlement of guaranteed debts',
      'Protects surviving owners from liability',
      'Maintains business credit rating',
...
export function RiskManagementPage() {
  ...
  useImagePreload([
    ...
    incomeProtectionImage,
    otherBenefitsImage,
    image_654751ca8be2c3a6b86cd56b21742e6d3ec469ec,
    keyPersonImage,
    contingentLiabilityImage,
  ]);
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          description:
            'Comprehensive risk cover for individuals and businesses. We search the market to find you the best protection at the right price — tailored to your life.',
          heroImage: outdoorFamilyImage,
          heroImageKey: 'risk-hero',
          heroImageAlt:
            'Happy family outdoors representing family protection and financial security',
        ...
        business: {
          ...
          subtitle:
            'Safeguarding business continuity, key personnel, and financial obligations — so nothing derails your business.',
        ...
        form: {
          ...
          textareaPlaceholder:
            'Tell us about your risk management requirements and family situation...',
        ...
        structuredDataOffers: [
          {
            name: 'Life Cover',
            description: 'Lump-sum payout to beneficiaries on death or terminal illness diagnosis.',
          },
          {
            name: 'Disability Cover',
            description: 'Once-off capital lump sum if permanently disabled and unable to work.',
          },
          {
            name: 'Severe Illness Cover',
            description: 'Tax-free lump sum on diagnosis of a covered critical illness.',
          },
          {
            name: 'Income Protection',
            description: 'Monthly income replacement of up to 75% if unable to work.',
          },
          {
            name: 'Buy & Sell Agreements',
            description:
              'Business continuity cover funding ownership transfer on death or disability.',
          },
          {
            name: 'Key Person Insurance',
            description:
              'Protects the business against financial loss from the death or disability of a key employee.',
          },
          {
            name: 'Contingent Liability Cover',
            description: 'Settles guaranteed business debts if an owner or guarantor dies.',
          },
        ],
        ...
        approach: {
          ...
          headerDescription:
            'At Navigate Wealth, we follow a proven 3-step methodology to ensure you receive the most appropriate risk management solution that aligns with your needs and budget.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'Comprehensive assessment of your unique risk profile, financial situation, and protection requirements.',
              details: [
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'Tailored risk management solutions with multiple provider options, designed around your specific needs.',
              details: [
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'Full explanation, terms review, and ongoing support commitment before any implementation.',
              details: [
          ...
          summaryCards: [],
          commitmentText:
            'We only proceed when you fully understand your chosen solution and are completely satisfied with your decision. Your peace of mind is our priority.',
        },
      }}
    />
  );

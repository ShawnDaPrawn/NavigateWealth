...
export function ContactPage() {
  ...
  const clientTypes = {
    individuals: {
      ...
      description:
        'Personal wealth management and financial planning for individuals and families.',
      services: [
            ...
            <div className="flex flex-col items-center text-center py-20 lg:py-28">
              ...
              <div className="max-w-3xl space-y-5">
                ...
                <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                  Ready to take control of your financial future? Schedule a complimentary
                  consultation with our wealth management experts.
                </p>
              </div>

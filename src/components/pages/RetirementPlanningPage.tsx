...
const individualProducts: Record<string, CoverContent> = {
  'retirement-annuities': {
    ...
    benefitsDescription:
      'Retirement annuities provide the cornerstone of retirement planning with generous tax deductions and long-term growth potential. These tax-advantaged vehicles allow you to save systematically for retirement while reducing your annual tax liability, ensuring your golden years are financially secure.',
    features: [
      ...
      { title: 'Flexible Contributions', description: 'Choose your monthly or lump-sum amounts' },
      {
        ...
        description: 'Expert fund managers optimise your portfolio',
      },
    ],
    benefits: [
      'Annual tax deduction up to R350,000',
  ...
  preservation: {
    ...
    benefitsDescription:
      'Preservation funds protect your accumulated retirement benefits when leaving employment, ensuring your retirement savings continue to grow tax-efficiently. These vehicles prevent the temptation to cash out retirement savings early, preserving your financial future.',
    features: [
    ...
    benefits: [
      'Preserve existing retirement benefits',
      'Continue tax-efficient growth',
      'No immediate tax implications',
      'Professional fund management',
      'Option to convert to living annuity',
    ],
  ...
  'living-annuities': {
    ...
    benefitsDescription:
      'Living annuities provide flexible retirement income solutions that allow you to remain invested while drawing a regular income. You maintain control over investment decisions and withdrawal rates, ensuring your retirement capital continues to grow while providing necessary income.',
    features: [
    ...
    benefits: [
      'Flexible withdrawal rates (2.5% - 17.5%)',
      'Investment choice and control',
      'Capital growth potential',
      'Inheritance benefits for heirs',
      'No prescribed minimum pension',
    ],
  ...
  'fixed-annuity': {
    ...
    benefitsDescription:
      'Fixed or Life Annuities provide guaranteed income for life, offering peace of mind with predictable monthly payments. These annuities protect against longevity risk, ensuring you never outlive your retirement savings while providing stable, inflation-adjusted income throughout your retirement years.',
    features: [
    ...
    benefits: [
      ...
      'Optional inflation-linked increases',
      'No investment risk exposure',
    ],
  ...
  'blended-annuity': {
    ...
    benefits: [
      'Mix of guaranteed and flexible income',
      'Partial longevity risk protection',
...
const businessProducts: Record<string, CoverContent> = {
  ...
  'provident-funds': {
    ...
    benefits: [
      'Full benefit access at retirement',
      'Flexible withdrawal options at resignation',
      'Tax-efficient employee benefits',
      'Optional preservation opportunities',
      'Simplified benefit communication',
    ],
  ...
  'group-ras': {
    ...
    benefits: [
      ...
      'Maximum portability between jobs',
      'Group discount rates',
      'Payroll deduction convenience',
      'Annual tax deductions up to R350,000',
    ],
  ...
  'annuity-products': {
    ...
    description:
      'Income solutions for retiring employees including living, life, and blended annuities.',
    benefitsDescription:
      "Annuity products provide retiring employees with various income options to convert their accumulated retirement savings into sustainable retirement income. Options include living annuities for flexibility and growth, life annuities for guaranteed income, or blended solutions combining security with opportunity, tailored to each retiree's needs and risk appetite.",
    features: [
    ...
    benefits: [
      'Multiple income solution options',
      'Living annuities with flexibility',
      'Life annuities with guarantees',
      'Blended annuity combinations',
...
export function RetirementPlanningPage() {
  useImagePreload([
    retirementHeroImage,
    image_9b5a01c260b3e9de54fd63026cbbfdec6cfc0d79,
    image_365200c034a353b5beb7a8f5a03c2a1a537c101b,
    image_ec64cc77fab63db12f681738be6d7e622f955e8c,
    image_c6ebf07ce2d2b7d5973be0c78b41cc2d3efbcf39,
    image_d84d9d4e620a44dabbbe1f028d18b3312e2327c0,
    image_623b0c66ffd502c662b87b4c531d9fe340d2de88,
    image_4660d44f48d1f87bfd648cf720e5e52343bf1111,
    image_eae92cb5e7bd56806577215e734f8b397daa3e46,
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          description:
            'Comprehensive retirement planning for individuals and businesses — from retirement annuities to pension funds, tailored to your goals.',
          heroImage: retirementHeroImage,
          heroImageKey: 'retirement-hero',
          heroImageAlt:
            'Happy retired couple enjoying financial freedom representing retirement planning success',
        ...
        form: {
          ...
          textareaPlaceholder:
            'Tell us about your retirement goals and current savings situation...',
        },
        ...
        structuredDataOffers: [
          {
            ...
            description: 'Tax-efficient long-term retirement savings with annual deductions.',
          },
          {
            name: 'Preservation Funds',
            description: 'Preserve and grow retirement benefits when changing jobs.',
          },
          {
            name: 'Living Annuities',
            description: 'Flexible retirement income with investment choice and control.',
          },
          { name: 'Fixed / Life Annuity', description: 'Guaranteed retirement income for life.' },
          {
            name: 'Blended Annuity',
            description: 'Combination of guaranteed income and investment growth.',
          },
          {
            name: 'Pension Funds',
            description: 'Employer-sponsored retirement benefits with tax advantages.',
          },
          {
            name: 'Provident Funds',
            description: 'Flexible retirement savings with full benefit access.',
          },
          {
            name: 'Group Retirement Annuities',
            description: 'Employer-facilitated savings with individual ownership.',
          },
        ],
        breadcrumbs: [
        ...
        approach: {
          ...
          headerDescription:
            'At Navigate Wealth, we follow a proven methodology to ensure your retirement strategy provides the income and security you need for a comfortable retirement.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'We analyse your current financial position, retirement goals, desired lifestyle, and existing provisions to identify gaps.',
              details: [
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'Based on your profile, we design a comprehensive retirement strategy with optimal product allocation and provider selection.',
              details: [
                'Customised retirement roadmap',
                'Product and provider comparison',
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'We implement your strategy and provide ongoing monitoring with annual reviews to keep you on track for a secure retirement.',
              details: [
          ...
          summaryCards: [],
          commitmentText:
            'We only proceed when you fully understand your retirement strategy and are completely satisfied with the plan. Your retirement security is our priority.',
        },
      }}
    />
  );

...
const individualProducts: Record<string, CoverContent> = {
  'life-cover': {
    ...
    description:
      'Comprehensive life insurance coverage provided through your employer with competitive rates.',
    benefitsDescription:
      "Group life cover provides essential financial protection for your family through employer-sponsored life insurance. This cost-effective coverage typically offers multiple times your annual salary as a death benefit, ensuring your family's financial security at affordable group rates.",
    features: [
  ...
  'medical-aid': {
    ...
    benefitsDescription:
      'Group medical aid provides comprehensive healthcare coverage through your employer at preferential group rates. These schemes typically offer better benefits and lower costs than individual medical aid, ensuring you and your family have access to quality healthcare.',
    features: [
  ...
  retirement: {
    ...
    description:
      'Employer-sponsored retirement savings with tax advantages and employer contributions.',
    benefitsDescription:
      'Group retirement benefits provide a foundation for your retirement savings through employer-sponsored pension or provident funds. These tax-efficient vehicles combine your contributions with employer contributions, creating a valuable long-term benefit for your financial future.',
    features: [
    ...
    benefits: [
      ...
      'Group administrative cost savings',
      'Portability on job changes',
    ],
  ...
  disability: {
    ...
    benefitsDescription:
      'Group disability benefits provide crucial income protection if you become unable to work due to illness or injury. These benefits typically replace a percentage of your income and may include lump-sum payments for permanent disability.',
    features: [
    ...
    benefits: [
      ...
      'Comprehensive disability definitions',
      'Rehabilitation support benefits',
    ],
  ...
  wellness: {
    ...
    benefitsDescription:
      'Employee wellness programs focus on preventative care and lifestyle support to improve your health and productivity. These comprehensive programs include health screenings, fitness benefits, mental health support, and wellness education.',
    features: [
...
const businessProducts: Record<string, CoverContent> = {
  'scheme-design': {
    ...
    description:
      "Customized employee benefit packages tailored to your company's needs and culture.",
    benefitsDescription:
      'Group benefit scheme design creates comprehensive employee benefit packages that align with your company culture, budget, and strategic objectives. Our approach ensures maximum value for both employer and employees while supporting talent attraction and retention goals.',
    features: [
    ...
    benefits: [
      'Customized benefit package design',
      'Budget-aligned solutions',
      'Employee needs analysis',
      'Competitive benchmarking',
      'Tax-efficient structure optimization',
    ],
  ...
  administration: {
    ...
    benefitsDescription:
      'Benefit administration services provide comprehensive management of all employee benefit programs, removing the administrative burden from your HR team. Our services include enrollment management, claims processing, compliance monitoring, and employee communication.',
    features: [
  ...
  compliance: {
    ...
    description:
      'Ensure your employee benefit programs meet all South African regulatory requirements.',
    benefitsDescription:
      'Regulatory compliance services ensure your employee benefit programs meet all legal requirements and industry regulations. Our expertise covers employment equity, POPIA compliance, and benefit legislation to protect your business from regulatory risks.',
    features: [
...
export function EmployeeBenefitsPage() {
  useImagePreload([
    image_e687c01861aee919fa24cf06bfbd5e069af5249c,
    employeeBenefitsBusinessImage,
    lifeCoverImage,
    medicalAidImage,
    retirementBenefitsImage,
    disabilityImage,
    wellnessImage,
    schemeDesignImage,
    administrationImage,
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          description:
            'Tailored employee benefits solutions — from group risk cover and retirement funds to medical aid and wellness programmes.',
          heroImage: image_e687c01861aee919fa24cf06bfbd5e069af5249c,
          heroImageKey: 'employee-benefits-hero',
          heroImageAlt:
            'Happy employees representing comprehensive employee benefits and workplace wellbeing',
        ...
        form: {
          ...
          textareaPlaceholder:
            'Tell us about your employee benefits requirements and company size...',
        },
        ...
        structuredDataOffers: [
          {
            ...
            description: 'Comprehensive employer-sponsored life insurance at group rates.',
          },
          {
            name: 'Group Medical Aid',
            description: 'Healthcare coverage through group medical schemes.',
          },
          {
            name: 'Group Retirement Benefits',
            description: 'Employer-sponsored retirement savings with tax advantages.',
          },
          {
            name: 'Group Disability Benefits',
            description: 'Income protection and disability coverage through employer schemes.',
          },
          {
            name: 'Employee Wellness Programs',
            description: 'Preventative health and wellness initiatives for employees.',
          },
          {
            name: 'Benefit Scheme Design',
            description: 'Customized employee benefit packages for businesses.',
          },
          {
            name: 'Benefit Administration',
            description: 'Complete management of employee benefit programs.',
          },
          {
            name: 'Regulatory Compliance',
            description: 'Ensure benefits meet all South African regulatory requirements.',
          },
        ],
        breadcrumbs: [
        ...
        approach: {
          ...
          headerDescription:
            'At Navigate Wealth, we follow a proven methodology to design, implement, and manage employee benefit solutions that attract and retain talent.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'We analyse your workforce demographics, current benefits, budget, and strategic objectives to identify the optimal benefit structure.',
              details: [
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'Based on your needs, we design a comprehensive benefits package with optimal provider selection and cost-effective structuring.',
              details: [
                'Customised benefit package',
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'We manage the full implementation and provide ongoing administration, compliance monitoring, and annual reviews.',
              details: [
          ...
          summaryCards: [],
          commitmentText:
            'We partner with your business to create a benefits strategy that supports your people and your bottom line. Your employees deserve the best.',
        },
      }}
    />
  );

...
const individualProducts: Record<string, CoverContent> = {
  wills: {
    ...
    description:
      'Professional will drafting and updates to ensure your wishes are legally documented.',
    benefitsDescription:
      'Will drafting ensures your assets are distributed according to your wishes while minimizing legal complications for your beneficiaries. Our comprehensive approach includes guardian appointments, executor selection, and clear asset distribution instructions that comply with South African law.',
    features: [
      {
        title: 'Legal Drafting',
        description: 'Professional will preparation by accredited drafters',
      },
  ...
  trusts: {
    ...
    benefitsDescription:
      'Trust structures provide sophisticated asset protection and tax planning opportunities while ensuring wealth preservation across generations. Our trust solutions offer creditor protection, estate duty savings, and flexible wealth distribution mechanisms.',
    features: [
  ...
  succession: {
    ...
    benefitsDescription:
      'Succession planning ensures orderly wealth transfer while minimizing taxes and family disputes. Our approach includes generation-skipping strategies, family governance structures, and educational programs for beneficiaries.',
    features: [
...
const businessProducts: Record<string, CoverContent> = {
  'business-succession': {
    ...
    benefitsDescription:
      'Business succession planning ensures your company continues to thrive after your departure while protecting stakeholder interests. Our approach includes leadership development, ownership transition strategies, and value preservation mechanisms.',
    features: [
  ...
  'buy-sell': {
    ...
    benefitsDescription:
      "Buy-sell agreements provide a structured legal framework that defines how business interests are transferred on the death or disability of a partner. Funded by life insurance, these agreements ensure surviving partners can acquire the deceased partner's share without financial strain.",
    features: [
      {
    ...
    benefits: [
      'Automatic valuation and transfer',
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          titleLine2: 'Legacy',
          description:
            'Comprehensive estate planning for individuals and businesses — wills, trusts, succession planning, and business continuity from accredited specialists.',
          heroImage: estatePlanningHeroImage,
          heroImageKey: 'estate-hero',
          heroImageAlt:
            'Estate planning consultation representing wealth transfer and legacy protection',
        ...
        form: {
          ...
          textareaPlaceholder:
            'Tell us about your estate planning requirements and family situation...',
        },
        ...
        structuredDataOffers: [
          { name: 'Wills & Testament', description: 'Professional will drafting and updates.' },
          {
            ...
            description: 'Family and inter vivos trusts for asset protection.',
          },
          { name: 'Succession Planning', description: 'Comprehensive wealth transfer strategies.' },
          {
            name: 'Business Succession Planning',
            description: 'Strategies for business continuity and ownership transfer.',
          },
          {
            name: 'Buy-Sell Agreements',
            description: 'Legal frameworks for business ownership transfers.',
          },
        ],
        breadcrumbs: [
        ...
        approach: {
          ...
          headerDescription:
            'At Navigate Wealth, we follow a proven methodology to ensure your estate plan comprehensively protects your family and preserves your legacy.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'We conduct a thorough review of your assets, liabilities, family structure, and existing estate plan to identify gaps and opportunities.',
              details: [
                'Asset and liability audit',
                'Family structure analysis',
                'Existing will and trust review',
                'Estate duty exposure assessment',
                'Beneficiary mapping',
              ],
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'Based on your assessment, we design a comprehensive estate plan with optimal structures for tax efficiency and family protection.',
              details: [
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'We implement your estate plan and provide ongoing reviews to ensure it remains aligned with your changing circumstances.',
              details: [
                'Document execution',
                'Trust establishment',
          ...
          summaryCards: [],
          commitmentText:
            'We ensure your estate plan is comprehensive, legally sound, and updated as your life evolves. Protecting your family is our commitment.',
        },
      }}
    />
  );

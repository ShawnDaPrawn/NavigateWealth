...
export function SitemapPage() {
  useEffect(() => {
    ...
    const structuredData = {
      ...
      description:
        'Complete navigation guide to all Navigate Wealth services, resources, and pages',
  ...
  const sitemapSections: SitemapSection[] = [
    {
      ...
      links: [
        ...
        },
        {
          ...
          path: '/services',
          description:
            'Comprehensive overview of our wealth management and financial planning services',
          lastModified: '2024-01-15',
          priority: 'high',
          status: 'public',
        },
        {
          ...
          path: '/team',
          description:
            'Meet our experienced financial advisors and wealth management professionals',
      ...
      links: [
        {
          ...
          description:
            'Comprehensive risk assessment and mitigation strategies for your financial portfolio',
          lastModified: '2024-01-15',
          priority: 'high',
          status: 'flexible',
        },
  ...
  const getPriorityBadge = (priority?: string) => {
    switch (priority) {
      ...
      case 'medium':
        return (
          <Badge className="bg-yellow-100 text-yellow-800 border-yellow-300">Medium Priority</Badge>
        );
      case 'low':
      ...
      <div className="bg-gradient-to-br from-purple-600 to-purple-800 text-white py-20">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Navigate Wealth Sitemap</h1>
            <p className="text-xl text-purple-100 mb-8 leading-relaxed">
              Complete navigation guide to all our services, resources, and tools. Find everything
              you need to manage your wealth and plan your financial future.
            </p>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4">
            {sitemapSections.map((section, index) => (
              ...
              >
                ...
                <span className="font-medium text-sm text-gray-900 group-hover:text-purple-900">
                  {section.title}
                </span>
              </a>
            ))}
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                              ...
                              {link.lastModified && <span>Last modified: {link.lastModified}</span>}
                            </div>
                          </div>
                          <Link
                            to={link.path}
        ...
        <div className="mt-16 pt-12 border-t border-gray-200">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-blue-200">
              ...
              <CardContent className="p-6">
                <p className="text-gray-600 mb-4">
                  This sitemap provides a comprehensive overview of all pages available on the
                  Navigate Wealth website. It's designed to help users and search engines understand
                  our site structure and find relevant content quickly.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>
                    • <strong>Public pages:</strong> Accessible to all visitors
                  </li>
                  <li>
                    • <strong>Login Required:</strong> Access requires user authentication
                  </li>
                  <li>
                    • <strong>Public/Authenticated:</strong> Available to both types of users
                  </li>
                  <li>
                    • <strong>Priority levels:</strong> Indicate relative importance for SEO
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-green-200">
              ...
              <CardContent className="p-6">
                <p className="text-gray-600 mb-4">
                  Can't find what you're looking for? Our team is here to help you navigate our
                  services and find the right financial solutions.
                </p>

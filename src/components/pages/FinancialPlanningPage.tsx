...
const heroImage =
  'https://images.unsplash.com/photo-1765438864227-288900d09d26?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaW5hbmNpYWwlMjBwbGFubmluZyUyMHN0cmF0ZWd5JTIwY29uc3VsdGF0aW9ufGVufDF8fHx8MTc3MjMyNDkyOXww&ixlib=rb-4.1.0&q=80&w=1080';
const comprehensiveImage =
  'https://images.unsplash.com/photo-1635322039171-4b9f2e0d5337?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWFsdGglMjBtYW5hZ2VtZW50JTIwcG9ydGZvbGlvJTIwcmV2aWV3fGVufDF8fHx8MTc3MjMyNDkzMHww&ixlib=rb-4.1.0&q=80&w=1080';
const investmentImage =
  'https://images.unsplash.com/photo-1768055104929-cf2317674a80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnZlc3RtZW50JTIwZ3Jvd3RoJTIwY2hhcnQlMjBhbmFseXNpc3xlbnwxfHx8fDE3NzIzMjQ5MzB8MA&ixlib=rb-4.1.0&q=80&w=1080';
const retirementImage =
  'https://images.unsplash.com/photo-1758686254493-d73c9c2a3049?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRpcmVtZW50JTIwc2F2aW5ncyUyMHBsYW5uaW5nJTIwY291cGxlfGVufDF8fHx8MTc3MjMyNDkzMXww&ixlib=rb-4.1.0&q=80&w=1080';
const taxImage =
  'https://images.unsplash.com/photo-1753955900083-b62ee8d97805?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0YXglMjBjYWxjdWxhdGlvbiUyMGRvY3VtZW50cyUyMGFjY291bnRpbmd8ZW58MXx8fHwxNzcyMzI0OTMxfDA&ixlib=rb-4.1.0&q=80&w=1080';
const debtImage =
  'https://images.unsplash.com/photo-1765868017186-18a3fc4c2942?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZWJ0JTIwbWFuYWdlbWVudCUyMGZpbmFuY2lhbCUyMGRvY3VtZW50c3xlbnwxfHx8fDE3NzIzMjQ5MzF8MA&ixlib=rb-4.1.0&q=80&w=1080';
const estateImage =
  'https://images.unsplash.com/photo-1766973305733-368e4604ce37?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlc3RhdGUlMjBwbGFubmluZyUyMGZhbWlseSUyMGxlZ2FjeXxlbnwxfHx8fDE3NzIzMjQ5MzJ8MA&ixlib=rb-4.1.0&q=80&w=1080';
const corporateImage =
  'https://images.unsplash.com/photo-1758518729711-1cbacd55efdb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3Jwb3JhdGUlMjBmaW5hbmNpYWwlMjB0ZWFtJTIwbWVldGluZ3xlbnwxfHx8fDE3NzIzMjQ5MzJ8MA&ixlib=rb-4.1.0&q=80&w=1080';
const cfoImage =
  'https://images.unsplash.com/photo-1574884280706-7342ca3d4231?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGZpbmFuY2UlMjBDRk8lMjBzdHJhdGVneXxlbnwxfHx8fDE3NzIzMjQ5MzN8MA&ixlib=rb-4.1.0&q=80&w=1080';
const cashflowImage =
  'https://images.unsplash.com/photo-1766503498598-494939f8d3b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXNoZmxvdyUyMG1hbmFnZW1lbnQlMjBidXNpbmVzc3xlbnwxfHx8fDE3NzIzMjQ5MzN8MA&ixlib=rb-4.1.0&q=80&w=1080';
...
const individualProducts: Record<string, CoverContent> = {
  comprehensive: {
    ...
    description:
      'A complete strategy covering all aspects of your financial life from budgeting to estate planning.',
    benefitsDescription:
      'Our comprehensive financial planning service takes a holistic view of your finances. We assess your current position, define your goals, and build a personalised strategy that integrates investments, retirement savings, risk cover, tax efficiency, and estate planning into a single, coherent roadmap.',
    features: [
      {
        title: 'Financial Assessment',
        description: 'Complete analysis of your current financial position',
      },
      ...
      { title: 'Cash Flow Optimisation', description: 'Maximise savings from existing income' },
      {
        ...
        description: 'Annual reviews to adapt to changing circumstances',
      },
    ],
    benefits: [
  ...
  investment: {
    ...
    description:
      'Customised investment strategies aligned with your risk tolerance and financial goals.',
    benefitsDescription:
      'We design tailored investment strategies that match your risk appetite, time horizon, and growth objectives. Our independent approach means we select from the full range of available products — unit trusts, tax-free savings, offshore investments, and more — to build the optimal portfolio for your needs.',
    features: [
  ...
  retirement: {
    ...
    description:
      'Strategic planning to ensure you can maintain your desired lifestyle in retirement.',
    benefitsDescription:
      'Our retirement planning service projects your future income needs, evaluates your current savings trajectory, and builds a strategy to close any gaps. We structure retirement annuities, preservation funds, and living annuities to maximise tax efficiency and ensure long-term income security.',
    features: [
      ...
      {
        title: 'Post-Retirement Planning',
        description: 'Living annuity vs guaranteed annuity analysis',
      },
  ...
  tax: {
    ...
    benefitsDescription:
      'Tax planning is integral to every financial decision. We work alongside your tax practitioner to ensure your investments, retirement savings, and estate plan are structured to minimise income tax, capital gains tax, and estate duty — all while remaining fully compliant with SARS regulations.',
    features: [
      {
        title: 'Tax-Efficient Structures',
        description: 'Endowments, TFSAs, and retirement vehicles',
      },
      { title: 'Capital Gains Planning', description: 'Minimise CGT on disposals and transfers' },
      {
        title: 'Estate Duty Strategy',
        description: 'Reduce estate duty through trusts and donations',
      },
  ...
  debt: {
    ...
    description:
      'Strategic debt management and elimination plans to improve your financial position.',
    benefitsDescription:
      'Effective debt management accelerates your path to financial freedom. We assess all outstanding debts, prioritise repayment strategies, negotiate better terms where possible, and integrate debt elimination into your broader financial plan — freeing up capital for wealth-building.',
    features: [
      {
        title: 'Debt Consolidation',
        description: 'Simplify multiple debts into manageable payments',
      },
  ...
  estate: {
    ...
    benefitsDescription:
      'Your financial plan must include provisions for the transfer of wealth to the next generation. We integrate will preparation, trust structures, and beneficiary optimisation into your comprehensive plan — ensuring your legacy is protected and estate duty is minimised.',
    features: [
...
const businessProducts: Record<string, CoverContent> = {
  corporate: {
    ...
    description:
      'Strategic financial planning for businesses to optimise growth, manage risk, and maximise shareholder value.',
    benefitsDescription:
      'Our corporate financial planning service helps businesses develop comprehensive strategies that align financial resources with business objectives. We assess capital structure, evaluate growth opportunities, and design risk management frameworks that protect and enhance business value.',
    features: [
  ...
  executive: {
    ...
    benefitsDescription:
      'Executive wealth planning addresses the unique financial needs of senior leaders — complex remuneration packages, share options, tax-efficient structuring, and succession considerations. We build bespoke strategies that protect and grow executive wealth across all financial dimensions.',
    features: [
      {
        title: 'Remuneration Analysis',
        description: 'Optimise salary, bonuses, and share options',
      },
  ...
  cashflow: {
    ...
    benefitsDescription:
      'Effective cash flow management is critical to business sustainability. We help businesses forecast cash requirements, optimise working capital cycles, and invest surplus funds productively — ensuring liquidity while maximising returns on idle capital.',
    features: [
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          description:
            'Comprehensive financial planning that aligns your money with your life goals. We create personalised strategies covering investments, retirement, tax, and estate planning.',
          heroImage: heroImage,
        ...
        business: {
          ...
          subtitle:
            'Strategic financial frameworks to optimise growth, manage risk, and maximise value.',
        ...
        structuredDataOffers: [
          {
            ...
            description:
              'Complete financial strategy covering investments, retirement, tax, and estate planning.',
          },
          {
            name: 'Investment Strategy Planning',
            description:
              'Customised investment strategies aligned with risk tolerance and financial goals.',
          },
          {
            name: 'Retirement Planning',
            description:
              'Strategic retirement planning to maintain your desired lifestyle in retirement.',
          },
          {
            name: 'Tax Planning & Optimisation',
            description:
              'Tax-efficient structuring of investments, retirement savings, and estate plans.',
          },
          {
            name: 'Debt Management Planning',
            description: 'Strategic debt elimination and credit improvement plans.',
          },
          {
            name: 'Estate Planning Integration',
            description:
              'Wills, trusts, and beneficiary planning integrated into your financial strategy.',
          },
          {
            name: 'Corporate Financial Planning',
            description:
              'Strategic financial planning for businesses to optimise growth and manage risk.',
          },
          {
            name: 'Executive Wealth Planning',
            description: 'Personalised financial strategies for executives and key personnel.',
          },
        ],
        ...
        approach: {
          ...
          headerDescription:
            'A proven methodology to create a comprehensive strategy that aligns your money with your life goals.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'We begin with a thorough assessment of your current financial position, goals, risk tolerance, and life circumstances.',
              details: [
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'We design a personalised financial strategy across all six planning areas, selecting the best products from the full market.',
              details: [
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'We implement your plan, monitor progress, and conduct regular reviews to keep your strategy aligned with your evolving life.',
              details: [
          ...
          summaryCards: [],
          commitmentText:
            'We only proceed when you fully understand your financial plan and are completely satisfied with every recommendation. Your financial success is our priority.',
        },
      }}
    />
  );

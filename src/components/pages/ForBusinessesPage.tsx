...
const services = [
  {
    ...
    description:
      'Comprehensive group health plans, retirement schemes, and employee benefit packages.',
    icon: Users,
...
const digitalFeatures = [
  {
    icon: Smartphone,
    title: 'Mobile Access',
    description: 'Manage your business finances from any device, anywhere',
  },
  {
    icon: Monitor,
    title: 'Dashboard',
    description: 'Real-time insights into your corporate portfolio and benefits',
  },
  {
    icon: FileText,
    title: 'Reporting',
    description: 'Detailed analytics and compliance reporting on demand',
  },
  {
    icon: HeadphonesIcon,
    title: 'Dedicated Support',
    description: 'Expert advisers assigned to your business for proactive guidance',
  },
];
...
export function ForBusinessesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        {...getSEOData('for-businesses')}
        structuredData={createWebPageSchema(
          getSEOData('for-businesses').title,
          getSEOData('for-businesses').description,
          getSEOData('for-businesses').canonicalUrl,
        )}
      />
          ...
          <div className="flex flex-col items-center text-center py-20 lg:py-28">
            ...
            <div className="max-w-3xl space-y-5">
              ...
              <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                We partner with businesses of all sizes to deliver comprehensive financial solutions
                that drive stability and growth — from employee benefits and cash management to risk
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                Every business has unique financial challenges and opportunities. Whether you're a
                startup looking to establish financial foundations, a growing company needing
                employee benefits, or an established enterprise seeking to optimize corporate
                treasury — we provide the expertise and solutions to support your journey at every
                stage.
              </p>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              Our business clients benefit from Navigate Wealth's institutional experience and
              provider relationships, while receiving the dedicated attention and tailored solutions
        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                Navigate Wealth combines cutting-edge financial technology with deep business
                expertise. Through our dedicated business portal, you can manage policies, access
                reports, and communicate with your financial team.
              </p>
              <p className="text-gray-500 leading-relaxed">
                Our experienced advisers provide strategic guidance and proactive support so you can
      ...
      <section className="bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
          <div className="max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              Whether you're looking to enhance employee benefits, optimize cash flow, or develop a
              comprehensive risk management strategy, our business financial experts are here to
              help you succeed.
            </p>

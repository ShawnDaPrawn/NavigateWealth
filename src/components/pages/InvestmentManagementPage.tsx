...
const individualProducts: Record<string, CoverContent> = {
  ...
  'offshore-unit-trusts': {
    ...
    benefitsDescription:
      'Offshore unit trusts provide diversification beyond South African borders, offering exposure to developed markets, global currencies, and international investment opportunities. These funds protect your wealth from local economic volatility and currency depreciation while accessing superior growth prospects in developed economies and emerging markets worldwide.',
    features: [
    ...
    benefits: [
      ...
      'Access to international managers',
      'Protection from local volatility',
  ...
  endowments: {
    ...
    benefits: [
      ...
      'No executor fees on proceeds',
      'Investment flexibility within wrapper',
    ],
...
const businessProducts: Record<string, CoverContent> = {
  ...
  'cash-management': {
    ...
    benefitsDescription:
      'Cash management solutions help businesses optimize their cash positions while maintaining liquidity for operational needs. Our approach ensures that idle funds generate competitive returns through money market instruments, call deposits, and short-term fixed income securities, while maintaining immediate access when cash is required.',
    features: [
      {
        title: 'Idle Cash Returns',
        description: 'Competitive rates on overnight and call deposits',
      },
    ...
    benefits: [
      ...
      'Professional cash optimization',
    ],
  ...
  treasury: {
    ...
    benefitsDescription:
      'Treasury management provides sophisticated cash flow optimization and working capital solutions for businesses. Our approach ensures optimal liquidity management while maximizing returns on excess cash, supporting business operations and growth initiatives through strategic financial planning.',
    features: [
      {
        title: 'Cash Flow Planning',
        description: 'Strategic cash flow forecasting and management',
      },
...
export function InvestmentManagementPage() {
  useImagePreload([
    ...
    unitTrustImage,
    taxFreeSavingsImage,
    offshoreUnitTrustsImage,
    endowmentsImage,
    offshoreEndowmentsImage,
    corporateImage,
    cashManagementImage,
    treasuryImage,
  ]);
    ...
    <ServicePageTemplate
      ...
      config={{
        ...
        hero: {
          ...
          description:
            "Expert investment management to build and preserve your wealth over time — with access to South Africa's leading fund managers.",
          heroImage: investmentGrowthImage,
          heroImageKey: 'investment-hero',
          heroImageAlt:
            'Investment growth concept showing stacked coins with growing plant representing wealth growth and investment protection',
        ...
        individuals: {
          ...
          imageAltMap: {
            ...
            'offshore-unit-trusts':
              'Global offshore investment exposure across international markets',
            endowments: 'Endowment policy tax efficiency and estate planning benefits',
            'offshore-endowments':
              'Offshore endowment combining global exposure with tax efficiency',
          },
          cardIcon: TrendingUp,
        ...
        structuredDataOffers: [
          ...
          },
          {
            ...
            description: 'Tax-efficient accounts with R36,000 annual and R500,000 lifetime limits.',
          },
          {
          ...
          {
            name: 'Endowments',
            description: 'Tax-efficient investment wrappers with estate planning benefits.',
          },
          {
            name: 'Offshore Endowments',
            description:
              'International endowment structures with global exposure and tax efficiency.',
          },
          {
            name: 'Corporate Investments',
            description: 'Professional management of company surplus funds.',
          },
          {
            name: 'Cash Management',
            description: 'Optimize business cash flows and maximize returns on idle funds.',
          },
          {
        ...
        approach: {
          ...
          headerDescription:
            'At Navigate Wealth, we follow a proven methodology to ensure your investment strategy aligns with your financial goals, risk appetite, and time horizon.',
          steps: [
            {
              step: '1',
              ...
              icon: Search,
              description:
                'We conduct a comprehensive analysis of your financial goals, risk tolerance, and investment time horizon.',
              details: [
            ...
            },
            {
              ...
              icon: MessageSquare,
              description:
                'Based on your profile, we design a tailored investment strategy with optimal asset allocation across multiple providers.',
              details: [
            ...
            },
            {
              ...
              icon: CheckCircle2,
              description:
                'We implement your strategy and provide ongoing monitoring with regular reviews to ensure continued alignment with your goals.',
              details: [
          ...
          summaryCards: [],
          commitmentText:
            'We only proceed when you fully understand your investment strategy and are completely satisfied with the approach. Your financial goals drive every decision we make.',
        },
      }}
    />
  );

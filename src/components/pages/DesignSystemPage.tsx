                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-4">
                        A comprehensive design system for professional wealth management interfaces,
                        featuring a clean white/light colour scheme with purple accents (#6d28d9),
                        complete authentication flows, and full admin capabilities. This is the
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            ...
                            window.scrollTo({
                              top: tabBarRef.current?.offsetTop || 0,
                              behavior: 'smooth',
                            });
                          }}
                      ...
                      return (
                        ...
                        >
                          <CardHeader className="pb-4">
                            ...
                            <CardTitle className="text-base md:text-lg text-black">
                              {card.title}
                            </CardTitle>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-300">
                        Explore the design system components and download the complete codebase to
                        start building.
                      </p>
                    </div>
            ...
            <TabsContent value="colors" className="mt-0">
              <div className="space-y-8 md:space-y-12">
                ...
                <div className="bg-gradient-to-br from-primary/5 via-primary/3 to-transparent rounded-2xl p-6 md:p-8 border border-primary/10">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-4">
                        A professional colour palette for wealth management interfaces. Primary
                        purple (#6d28d9) provides brand identity. Dark navy (#313653) is the
                        standard dark section background, applied via the{' '}
                    ...
                    <div key={category}>
                      <div className="flex items-center justify-between mb-4 md:mb-6">
                        ...
                        <Badge variant="outline" className="border-gray-300 text-gray-600">
                          ...
                          {categoryColors.length === 1 ? 'Colour' : 'Colours'}
                        </Badge>
                      </div>
                      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                              ...
                              <div className="p-4 md:p-5 space-y-3">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button
                                      onClick={() =>
                                        copyToClipboard(color.value, `${color.name}-hex`)
                                      }
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    <button
                                      onClick={() =>
                                        copyToClipboard(color.tailwind, `${color.name}-tw`)
                                      }
                ...
                <Alert className="border-primary/20 bg-primary/5">
                  ...
                  <AlertDescription className="text-gray-600 text-sm">
                    All colour combinations meet WCAG 2.1 Level AA standards for contrast ratios.
                    Primary purple on white provides 4.5:1 contrast, and all text colours ensure
                    readability.
                  </AlertDescription>
                </Alert>
              </div>
            ...
            <TabsContent value="components" className="mt-0">
              <div className="space-y-8 md:space-y-12">
                <div className="bg-gradient-to-br from-primary/5 via-primary/3 to-transparent rounded-2xl p-6 md:p-8 border border-primary/10">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-4">
                        A comprehensive collection of React components built with shadcn/ui and
                        styled for the Navigate Wealth platform. All components are fully responsive
                          ...
                          {expandedCode === component.id && (
                            <div className="relative group/code">
                              ...
                              <Button
                                ...
                                variant="secondary"
                                onClick={() =>
                                  copyToClipboard(component.code, `${component.id}-code`)
                                }
                ...
                <Alert className="border-primary/20 bg-primary/5">
                  ...
                  <AlertDescription className="text-gray-600 text-sm">
                    All components are built with shadcn/ui and can be imported directly into your
                    project. Copy the code snippets and customise them to match your specific needs.
                    Click the chevron to expand code blocks.
                  </AlertDescription>
                </Alert>
              </div>
            </TabsContent>
              ...
              <div className="space-y-8 md:space-y-12">
                <div className="bg-gradient-to-br from-primary/5 via-primary/3 to-transparent rounded-2xl p-6 md:p-8 border border-primary/10">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-4">
                        Pre-built section templates with consistent spacing, responsive containers,
                        and colour schemes. These sections form the building blocks of your pages
                        with standardised padding and max-width containers.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-primary/10 text-primary border-primary/20">
                    ...
                    >
                      ...
                      <CardContent className="space-y-4 md:space-y-6">
                        <div>
                          ...
                          <div className="border-2 border-gray-200 rounded-lg overflow-hidden">
                            <div className={`${section.className} p-6 md:p-10`}>
                              ...
                              >
                                This is how content appears in this section type. Includes proper
                        ...
                        <div>
                          <button
                            onClick={() =>
                              setExpandedCode(expandedCode === section.id ? null : section.id)
                            }
                            className="w-full flex items-center justify-between mb-3 group"
                          >
                            <span className="text-sm font-semibold text-black flex items-center">
                        ...
                        <Alert className="border-gray-200 bg-gray-50">
                          ...
                          <AlertDescription className="text-xs md:text-sm text-gray-600">
                            <strong>Container:</strong> max-w-screen-2xl with responsive padding
                            (px-4 sm:px-6 lg:px-8 xl:px-12) &middot;{' '}
                            <strong className="ml-2">Spacing:</strong> py-20 (80px) vertical padding
                          </AlertDescription>
                        </Alert>
                      </CardContent>
                    </Card>
                ...
                <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                  <Alert className="border-primary/20 bg-primary/5">
                    ...
                    <AlertDescription className="text-gray-600 text-sm">
                      All sections use the max-w-screen-2xl container with consistent responsive
                      padding for uniform layouts across the site.
                    </AlertDescription>
                  </Alert>
                  <Alert className="border-primary/20 bg-primary/5">
                    <Info className="h-4 w-4 text-primary" />
                    ...
                    <AlertDescription className="text-gray-600 text-sm">
                      Dark sections use white/light text (text-white, text-gray-300). Light sections
                      use dark text (text-black, text-gray-600).
                    </AlertDescription>
                  </Alert>
                </div>
              </div>

                          ...
                          <div className="contents">
                            <div className="sm:col-span-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  updateBankAccount(account.id, { customBankName: e.target.value })
                                }
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => bankAccountToDelete && removeBankAccount(bankAccountToDelete)}
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() => proofOfBankToDelete && removeProofOfBank(proofOfBankToDelete)}
              className="bg-red-600 hover:bg-red-700"
            >
              Delete
            </AlertDialogAction>

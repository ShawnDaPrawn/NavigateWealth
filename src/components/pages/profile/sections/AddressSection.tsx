            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={profileData.residentialAddressLine1}
              ...
              <div>
                ...
                <Input
                  ...
                  value={profileData.residentialAddressLine2}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    id="residentialCity"
                    value={profileData.residentialCity}
                ...
                <div>
                  ...
                  <Select
                    value={profileData.residentialProvince}
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={profileData.residentialPostalCode}
              ...
              <div>
                ...
                <Input
                  ...
                  value={profileData.residentialCountry}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-900">
                          {profileData.proofOfResidenceFileName || 'Proof of Residence'}
                        </p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <Input
                  id="workAddressLine1"
                  value={profileData.workAddressLine1}
              ...
              <div>
                ...
                <Input
                  id="workAddressLine2"
                  value={profileData.workAddressLine2}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={profileData.workProvince}
                ...
                <div>
                  ...
                  <Input
                    id="workPostalCode"
                    value={profileData.workPostalCode}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete your proof of residence document? This action cannot
              be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setProofOfResidenceToDelete(false)}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction

        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Your work and income details</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
            ...
            <div className="contents">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-sm text-gray-900">Your Employers</h4>
                    <p className="text-xs text-gray-500">Add all your current employers</p>
                  </div>
                  <Button
                    onClick={addEmployer}
                    size="sm"
                        ...
                        >
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                {employer.jobTitle && !isInEditMode && (
                                  <p className="text-xs text-gray-600">{employer.jobTitle}</p>
                                )}
                              </div>
                            </div>
                          ...
                          {isInEditMode ? (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              ...
                              <div>
                                <Label htmlFor={`job-title-${employer.id}`}>Job Title *</Label>
                                <Input
                              ...
                              <div>
                                <Label htmlFor={`employer-industry-${employer.id}`}>
                                  Industry *
                                </Label>
                                <Input
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                              <div>
                                <p className="text-gray-600 text-[14px]">Industry</p>
          ...
          {profileData.employmentStatus === 'self-employed' && (
            <div className="contents">
              ...
              <div className="space-y-4">
                <div
                  className={`p-5 rounded-lg border-2 ${selfEmployedInEditMode ? 'border-[#6d28d9] bg-white' : 'border-gray-200 bg-white'}`}
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <div className="h-10 w-10 rounded-lg bg-purple-100 flex items-center justify-center">
                      ...
                      <div>
                        <h4 className="text-gray-900">
                          {profileData.selfEmployedCompanyName || 'Self-Employment Details'}
                        </h4>
                        {profileData.selfEmployedIndustry && !selfEmployedInEditMode && (
                    ...
                    {!selfEmployedInEditMode ? (
                      ...
                      <div className="contents">
                        ...
                        <Button
                          ...
                          className={`${!profileData.selfEmployedIndustry || !profileData.selfEmployedDescription ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-[#6d28d9] text-white hover:bg-[#5b21b6]'} border-[#6d28d9]`}
                        >
                          <Check className="h-4 w-4 mr-1" />
                          Save
                        </Button>
                  ...
                  {selfEmployedInEditMode ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="sm:col-span-2">
                        <Label htmlFor="selfEmployedCompanyName">Company / Business Name</Label>
                        <Input
                          id="selfEmployedCompanyName"
                          value={profileData.selfEmployedCompanyName}
                          onChange={(e) =>
                      ...
                      <div className="sm:col-span-2">
                        <Label htmlFor="selfEmployedIndustry">Industry of Operation *</Label>
                        <Input
                          id="selfEmployedIndustry"
                          value={profileData.selfEmployedIndustry}
                          onChange={(e) =>
                      ...
                      <div className="sm:col-span-2">
                        <Label htmlFor="selfEmployedDescription">Business Description *</Label>
                        <Textarea
                          id="selfEmployedDescription"
                          value={profileData.selfEmployedDescription}
                          onChange={(e) =>
            ...
            <div className="contents">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {profileData.additionalIncomeSources.length} source(s) added
                </p>
              </div>
            </div>
          )}
      ...
      <AlertDialog open={employerToDelete !== null} onOpenChange={() => setEmployerToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this employer entry? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={() => employerToDelete && removeEmployer(employerToDelete)}

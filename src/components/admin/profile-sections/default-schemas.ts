...
export const DEFAULT_SCHEMAS: Record<string, { fields: DefaultSchemaField[] }> = {
  ...
  retirement_pre: {
    fields: [
      ...
      {
        id: 'ret_pre_inception',
        name: 'Date of Inception',
        type: 'date',
        required: false,
        keyId: 'retirement_date_of_inception',
      },
      {
        id: 'ret_pre_2',
        name: 'Product Type',
      ...
      },
      {
        ...
        type: 'date',
        required: false,
        keyId: 'retirement_maturity_date',
      },
      {
        id: 'ret_pre_6',
        name: 'Premium',
      ...
      { id: 'ret_pre_7', name: 'Notes', type: 'long_text', required: false },
      {
        ...
        type: 'percentage',
        required: false,
        keyId: 'retirement_assumptions_growth',
      },
      {
        id: 'ret_pre_10',
        name: 'Premium escalation (%) — anniversary',
        type: 'percentage',
        required: false,
        keyId: 'retirement_assumptions_escalation',
      },
    ],
  },
  retirement_post: {
  ...
  investments_voluntary: {
    fields: [
      ...
      {
        id: 'inv_vol_inception',
        name: 'Date of Inception',
        type: 'date',
        required: false,
        keyId: 'invest_date_of_inception',
      },
      {
        id: 'inv_vol_2',
        name: 'Product Type',
      ...
      {
        id: 'inv_vol_9',
        name: 'Contribution escalation (%) — anniversary',
        type: 'percentage',
        required: false,
        keyId: 'invest_assumptions_escalation',
      },
  ...
  investments_guaranteed: {
    fields: [
      ...
      },
      {
        ...
        type: 'currency',
        required: true,
        keyId: 'invest_guaranteed_capital',
      },
      {
        id: 'inv_gua_4',
      ...
      },
      {
        ...
        type: 'date',
        required: true,
        keyId: 'invest_guaranteed_maturity_date',
      },
      {
        id: 'inv_gua_6',
        name: 'Maturity Value',
        type: 'currency',
        required: true,
        keyId: 'invest_guaranteed_maturity_value',
      },
  ...
  employee_benefits_retirement: {
    fields: [
      ...
      { id: 'eb_ret_2', name: 'Employer', type: 'text', required: true },
      {
        ...
        type: 'dropdown',
        required: true,
        options: ['Pension Fund', 'Provident Fund'],
      },

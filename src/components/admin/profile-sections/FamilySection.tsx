...
export function FamilySection({
  ...
  return (
    <div className="contents">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              title={
                familyMembersInEditMode.size > 0
                  ? 'Please save the current family member before adding a new one'
        ...
        <CardContent>
          {(profileData.familyMembers as FamilyMember[]).length === 0 ? (
            ...
            <div className="space-y-4">
              {(profileData.familyMembers as FamilyMember[]).map(
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateFamilyMember(member.id, { dateOfBirth: e.target.value })
                              }
                              className="mt-1.5"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateFamilyMember(member.id, { idPassportNumber: e.target.value })
                              }
                            ...
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                updateFamilyMember(member.id, {
                                  isFinanciallyDependent: checked as boolean,
                                })
                              }
                            />
                            <Label
                              htmlFor={`dependent-${member.id}`}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            ...
                            {member.gender && (
                              <div>
                                ...
                                <p className="text-gray-900 capitalize text-[12px]">
                                  {member.gender}
                                </p>
                              </div>
                            )}
      ...
      <AlertDialog
        open={familyMemberToDelete !== null}
        onOpenChange={() => setFamilyMemberToDelete(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Family Member</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to delete this family member? This action cannot be undone and
              all information about this family member will be permanently removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setFamilyMemberToDelete(null)}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction onClick={removeFamilyMember} className="bg-red-600 hover:bg-red-700">
              Delete
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>

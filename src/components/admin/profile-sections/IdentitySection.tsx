...
export function IdentitySection({
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  ...
                  {identityDocuments.length === 1 ? 'KYC document' : 'KYC documents'} on file
                </CardDescription>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          {identityDocuments.map((doc: IdentityDocument) => {
            ...
            return (
              <Card
                key={doc.id}
                className={`relative overflow-hidden ${expired ? 'border-red-300' : expiringSoon ? 'border-orange-300' : ''}`}
              >
                {/* Status Bar */}
                <div
                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div
                          className={`h-12 w-12 rounded-xl ${config.bgColor} flex items-center justify-center`}
                        >
                    ...
                    {isEditing ? (
                      ...
                      <div className="space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          {showIdentityFields && (
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  updateIdentityDocument(doc.id, { countryOfIssue: e.target.value })
                                }
                          ...
                          <div
                            className={showIdentityFields ? 'space-y-2' : 'space-y-2 md:col-span-2'}
                          >
                      ...
                      <div className="space-y-3">
                        {/* Document Fields */}
                        <div
                          className={`grid grid-cols-1 ${showIdentityFields ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-3`}
                        >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {doc.number && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleCopyToClipboard(doc.number, 'Document Number')
                                    }
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {doc.countryOfIssue && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleCopyToClipboard(doc.countryOfIssue, 'Country of Issue')
                                    }
                                    className="h-7 w-7 p-0 hover:bg-gray-50 flex-shrink-0"
                                  >
                                    <Copy className="h-3.5 w-3.5 text-gray-500" />
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {doc.expiryDate && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleCopyToClipboard(doc.expiryDate, 'Expiry Date')
                                    }
                                    className="h-7 w-7 p-0 hover:bg-gray-50 flex-shrink-0"
                                  >
                                    <Copy className="h-3.5 w-3.5 text-gray-500" />
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  {!doc.fileUrl && (
                                    <p className="text-xs text-orange-600 mt-1">
                                      ⚠ File not available for viewing. Please re-upload to enable
                                      preview.
                                    </p>
                                  )}
                                </div>
                    ...
                    {!isEditing && showIdentityFields && expiringSoon && !expired && (
                      <Alert className="bg-orange-50 border-orange-200">
                        ...
                        <AlertDescription className="text-sm text-orange-800">
                          ...
                          {new Date(doc.expiryDate).toLocaleDateString('en-ZA')}. Please update it
                          soon.
                        </AlertDescription>
                      </Alert>
                    )}
                    ...
                    {!isEditing && showIdentityFields && expired && (
                      <Alert className="bg-red-50 border-red-200">
                        ...
                        <AlertDescription className="text-sm text-red-800">
                          ...
                          {new Date(doc.expiryDate).toLocaleDateString('en-ZA')}. Please update
                          immediately.
                        </AlertDescription>
                      </Alert>
                    )}
      ...
      <AlertDialog
        open={!!identityDocToDelete}
        onOpenChange={(open) => !open && setIdentityDocToDelete(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete KYC Document?</AlertDialogTitle>
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the KYC document from the
              system.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setIdentityDocToDelete(null)}>
              Cancel
            </AlertDialogCancel>

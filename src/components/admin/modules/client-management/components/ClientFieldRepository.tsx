...
export const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  {
    id: 'age',
    path: 'personalInformation.age',
    description: 'Current Age (Derived from Date of Birth)',
    type: 'number',
  ...
  {
    id: 'idNumber',
    path: 'personalInformation.idNumber',
  ...
  {
    id: 'passportNumber',
    path: 'personalInformation.passportNumber',
    description: 'Passport Number (if applicable)',
    type: 'string',
  },
  {
    id: 'maritalStatus',
    path: 'personalInformation.maritalStatus',
  ...
  {
    id: 'spouseName',
    path: 'personalInformation.spouseName',
    description: "Spouse's full name",
    type: 'string',
  },
  {
    id: 'spouseDateOfBirth',
    path: 'personalInformation.spouseDateOfBirth',
    description: "Spouse's date of birth",
    type: 'date',
  },
  {
    id: 'spouseIncome',
    path: 'personalInformation.spouseIncome',
  ...
  {
    id: 'phone',
    path: 'personalInformation.cellphone',
  ...
  {
    id: 'grossIncome',
    path: 'employmentInformation.grossIncome',
    description: 'Gross monthly income',
    type: 'number',
    source: 'Also checked at root: grossIncome',
  },
  {
    id: 'netIncome',
    path: 'employmentInformation.netIncome',
    description: 'Net monthly income',
    type: 'number',
    source: 'Also checked at root: netIncome',
  },
  {
    id: 'occupation',
    path: 'employmentInformation.occupation',
    description: 'Current occupation',
    type: 'string',
  },
  {
    id: 'employer',
    path: 'employmentInformation.employer',
    description: 'Current employer',
    type: 'string',
  },
  {
    id: 'grossMonthlyIncome',
    path: 'employmentInformation.grossMonthlyIncome',
    description: 'Gross monthly income (Primary)',
    type: 'number',
    source: 'Root: grossMonthlyIncome',
  },
  {
    id: 'netMonthlyIncome',
    path: 'employmentInformation.netMonthlyIncome',
    description: 'Net monthly income (Primary)',
    type: 'number',
    source: 'Root: netMonthlyIncome',
  },
  {
    id: 'grossAnnualIncome',
    path: 'employmentInformation.grossAnnualIncome',
    description: 'Gross annual income',
    type: 'number',
    source: 'Root: grossAnnualIncome',
  },
  {
    id: 'netAnnualIncome',
    path: 'employmentInformation.netAnnualIncome',
    description: 'Net annual income',
    type: 'number',
    source: 'Root: netAnnualIncome',
  },

  // Financial Information
  {
    id: 'monthlyEssentialExpenses',
    path: 'financialInformation.monthlyEssentialExpenses',
    description: 'Essential monthly expenses',
    type: 'number',
  },
  {
    id: 'monthlyTotalExpenses',
    path: 'financialInformation.monthlyTotalExpenses',
    description: 'Total monthly expenses',
    type: 'number',
  },
  {
    id: 'monthlyRetirementSaving',
    path: 'financialInformation.monthlyRetirementSaving',
    description: 'Monthly retirement contribution',
    type: 'number',
  },
  {
    id: 'expectedRetirementAge',
    path: 'personalInformation.expectedRetirementAge',
  ...
  // Arrays / Collections
  {
    id: 'familyMembers',
    path: 'familyMembers',
    description: 'List of family members/dependants',
    type: 'array',
  },
  {
    id: 'liabilities',
    path: 'liabilities',
    description: 'List of debts and liabilities',
    type: 'array',
  },
  ...
  {
    id: 'dependantName',
    path: 'familyMembers[].fullName',
    description: 'Family member name',
    type: 'string',
  },
  {
    id: 'dependantRelation',
    path: 'familyMembers[].relationship',
    description: 'Relationship to client',
    type: 'string',
  },
  {
    id: 'dependantDependency',
    path: 'familyMembers[].isFinanciallyDependent',
    description: 'Is financially dependent?',
    type: 'boolean',
  },

  {
    id: 'liabilityType',
    path: 'liabilities[].type',
    description: 'Type of liability (e.g., Bond, Vehicle)',
    type: 'string',
  },
  {
    id: 'liabilityBalance',
    path: 'liabilities[].outstandingBalance',
...
export function ClientFieldRepository({ open, onOpenChange }: ClientFieldRepositoryProps) {
  ...
  const filteredFields = FIELD_DEFINITIONS.filter(
    (field) =>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[80vh] flex flex-col">
        ...
        <div className="text-xs text-muted-foreground pt-4">
          <strong>Usage:</strong> These fields are stored in the Key-Value store under the key
          format <code>user_profile:{'{userId}'}:personal_info</code>.
        </div>
      </DialogContent>
    </Dialog>
  );

...
const PREFILL_TOKEN_OPTIONS: Array<{ value: PrefillToken | ''; label: string; group: string }> = [
  ...
  { value: 'client.tax_number', label: 'Client tax number', group: 'Client (CRM)' },
  { value: 'client.date_of_birth', label: 'Client date of birth', group: 'Client (CRM)' },
  { value: 'client.marital_status', label: 'Client marital status', group: 'Client (CRM)' },
  { value: 'key:profile_first_name', label: 'Profile first name', group: 'Key Manager' },
  { value: 'key:profile_last_name', label: 'Profile last name', group: 'Key Manager' },
  { value: 'key:profile_email', label: 'Profile email', group: 'Key Manager' },
  { value: 'key:profile_phone_number', label: 'Profile phone', group: 'Key Manager' },
  { value: 'key:profile_id_number', label: 'Profile ID number', group: 'Key Manager' },

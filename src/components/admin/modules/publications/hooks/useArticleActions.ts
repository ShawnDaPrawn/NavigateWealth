...
interface UseArticleActionsReturn {
  ...
  ) => Promise<ArticlePublishResponse | null>;
...
export function useArticleActions(options?: UseArticleActionsOptions): UseArticleActionsReturn {
  ...
  const handleCreate = useCallback(
    async (data: CreateArticleInput): Promise<Article | null> => {
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleCreateFailed;
  ...
  const handleUpdate = useCallback(
    async (id: string, data: UpdateArticleInput): Promise<Article | null> => {
      setIsProcessing(true);
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleUpdateFailed;
  ...
  const handlePublish = useCallback(
    async (id: string, notifySubscribers?: boolean): Promise<ArticlePublishResponse | null> => {
      setIsProcessing(true);
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articlePublishFailed;
  ...
  const handleUnpublish = useCallback(
    async (id: string): Promise<Article | null> => {
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleUnpublishFailed;
  ...
  const handleSchedule = useCallback(
    async (id: string, publishAt: string, notifyOnPublish?: boolean): Promise<Article | null> => {
      setIsProcessing(true);
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleScheduleFailed;
  ...
  const handleDelete = useCallback(
    async (id: string): Promise<boolean> => {
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleDeleteFailed;
  ...
  const handleDuplicate = useCallback(
    async (id: string): Promise<Article | null> => {
      ...
      try {
        ...
        const article = await PublicationsAPI.Articles.createArticle(
          copyData as CreateArticleInput,
        );
        ...
        const errorMessage =
          err instanceof Error ? err.message : ERROR_MESSAGES.articleDuplicateFailed;

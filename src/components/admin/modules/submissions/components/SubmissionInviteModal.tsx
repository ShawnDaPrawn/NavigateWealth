...
import { SUBMISSION_INVITE_TYPES, SITE_BASE_URL, type SubmissionInviteType } from '../constants';
        ...
        >
          ...
          <div className="px-6 py-4 border-b flex items-center justify-between bg-white shrink-0">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <DialogTitle className="text-lg font-bold text-gray-900 leading-tight">
                  {step === 'select' ? 'Invite Client' : selectedType?.label || 'Send Invitation'}
                </DialogTitle>
            ...
            {step === 'compose' && selectedType && (
              ...
              >
                {resolveInviteIcon(
                  selectedType.iconName,
                  cn('h-4.5 w-4.5', selectedType.iconTextClass),
                )}
              </div>
            )}
          </div>
                  ...
                  {SUBMISSION_INVITE_TYPES.map((inviteType) => (
                    ...
                    >
                      ...
                      >
                        {resolveInviteIcon(
                          inviteType.iconName,
                          cn('h-5 w-5', inviteType.iconTextClass),
                        )}
                      </div>
                ...
                <div className="p-6 space-y-5">
                  ...
                  <section>
                    ...
                    <p className="text-xs text-gray-400 mb-3">
                      Copy this link to share via WhatsApp, SMS, newsletters, or any communication
                      channel.
                    </p>
          ...
          {step === 'select' && (
            <div className="border-t border-gray-100 px-6 py-3 bg-gray-50/50 shrink-0">
              <p className="text-[11px] text-gray-400 text-center">
                Links include UTM tracking for analytics. Emails are sent from
                info@navigatewealth.co using the Navigate Wealth branded template.
              </p>
            </div>
          )}
        </DialogContent>

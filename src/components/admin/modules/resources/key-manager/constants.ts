...
export const KEY_USAGE_MAP: Record<string, KeyModuleName[]> = {
  ...
  risk_severe_illness: [KEY_MODULES.RISK_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  risk_disability: [KEY_MODULES.RISK_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  risk_temporary_icb: [KEY_MODULES.RISK_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  risk_permanent_icb: [KEY_MODULES.RISK_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  risk_icb_waiting_period: [KEY_MODULES.RISK_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  ...
  risk_severe_illness_total: [KEY_MODULES.RISK_FNA, KEY_MODULES.CLIENT_DASHBOARD],
  risk_disability_total: [KEY_MODULES.RISK_FNA, KEY_MODULES.CLIENT_DASHBOARD],
  risk_temporary_icb_total: [KEY_MODULES.RISK_FNA, KEY_MODULES.CLIENT_DASHBOARD],
  risk_permanent_icb_total: [KEY_MODULES.RISK_FNA, KEY_MODULES.CLIENT_DASHBOARD],
  risk_total_premium: [
    KEY_MODULES.RISK_FNA,
    KEY_MODULES.CLIENT_DASHBOARD,
    KEY_MODULES.FINANCIAL_REPORTS,
  ...
  medical_aid_msa: [KEY_MODULES.POLICY_MANAGEMENT, KEY_MODULES.MEDICAL_FNA],
  medical_aid_late_joiner_penalty: [KEY_MODULES.POLICY_MANAGEMENT, KEY_MODULES.MEDICAL_FNA],
  medical_aid_hospital_tariff: [KEY_MODULES.POLICY_MANAGEMENT, KEY_MODULES.MEDICAL_FNA],
  medical_aid_plan_type: [KEY_MODULES.MEDICAL_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  medical_aid_dependents: [KEY_MODULES.MEDICAL_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  ...
  retirement_fund_type: [KEY_MODULES.RETIREMENT_FNA, KEY_MODULES.POLICY_MANAGEMENT],
  ...
  invest_product_type: [KEY_MODULES.INVESTMENT_INA, KEY_MODULES.POLICY_MANAGEMENT],
  ...
  eb_group_life_cover: [KEY_MODULES.EMPLOYEE_BENEFITS, KEY_MODULES.POLICY_MANAGEMENT],
  eb_group_disability: [KEY_MODULES.EMPLOYEE_BENEFITS, KEY_MODULES.POLICY_MANAGEMENT],
  eb_group_ip_monthly: [KEY_MODULES.EMPLOYEE_BENEFITS, KEY_MODULES.POLICY_MANAGEMENT],
  eb_monthly_premium: [
  ...
  estate_will_date: [KEY_MODULES.ESTATE_PLANNING_FNA, KEY_MODULES.COMPLIANCE],
  estate_executor_appointed: [KEY_MODULES.ESTATE_PLANNING_FNA, KEY_MODULES.COMPLIANCE],
  estate_trust_value: [KEY_MODULES.ESTATE_PLANNING_FNA, KEY_MODULES.CLIENT_DASHBOARD],
  estate_annual_fee: [
  ...
  tax_retirement_contributions: [KEY_MODULES.TAX_PLANNING_FNA, KEY_MODULES.FINANCIAL_REPORTS],
  tax_medical_aid_credits: [KEY_MODULES.TAX_PLANNING_FNA, KEY_MODULES.FINANCIAL_REPORTS],
  tax_annual_fee: [
    KEY_MODULES.TAX_PLANNING_FNA,
    KEY_MODULES.POLICY_MANAGEMENT,
    KEY_MODULES.FINANCIAL_REPORTS,

              ...
              <AccordionItem key={row.id} value={row.id}>
                ...
                <AccordionContent className="space-y-4 pt-2">
                  {row.cells.map((cell, cellIndex) => (
                    <div
                      key={cellIndex}
                      className="bg-gray-50 p-3 rounded-md border border-gray-100 space-y-2"
                    >
                      <div className="flex items-center justify-between">
                      ...
                      {cell.type === 'static' ? (
                        <Input
                          value={cell.value}
                          onChange={(e) =>
                            updateCell(rowIndex, cellIndex, { value: e.target.value })
                          }
                        ...
                        <div className="space-y-2">
                          <Select
                            ...
                            value={
                              CLIENT_FIELDS.some((f) => f.value === cell.value) ? cell.value : ''
                            }
                          >
                          ...
                          <div className="relative">
                            <span className="absolute left-2 top-2 text-xs text-blue-500 font-mono">
                              {'{{'}
                            </span>
                            <Input
                              value={cell.value}
                            ...
                            />
                            <span className="absolute right-2 top-2 text-xs text-blue-500 font-mono">
                              {'}}'}
                            </span>
                          </div>
                        </div>

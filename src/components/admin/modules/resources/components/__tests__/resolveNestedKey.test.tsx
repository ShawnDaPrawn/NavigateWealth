...
const cases: TestCase[] = [
  ...
  {
    label: 'nested one-level path',
    path: 'personalInformation.idNumber',
    expected: '9001015009087',
  },
  {
    label: 'nested two-level path',
    path: 'personalInformation.address.city',
    expected: 'Johannesburg',
  },
  {
    label: 'nested missing leaf key',
    path: 'personalInformation.address.province',
    expected: undefined,
  },
  ...
  {
    label: 'template wrapping around nested path',
    path: '{{personalInformation.idNumber}}',
    expected: '9001015009087',
  },
  {

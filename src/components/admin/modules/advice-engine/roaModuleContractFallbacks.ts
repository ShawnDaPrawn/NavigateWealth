...
type DocumentSectionSeed = Omit<RoAModuleContract['documentSections'][number], 'template'> & {
  template?: string;
};
...
function contract(seed: ContractSeed): RoAModuleContract {
  ...
  return {
    ...
    compileOrder: [...seed.documentSections]
...
export const FALLBACK_ROA_MODULE_CONTRACTS: RoAModuleContract[] = [
  contract({
    ...
    description:
      'Recommends new life assurance cover based on client needs, affordability and suitability.',
    ...
    documentSections: [
      {
        ...
        purpose: 'Explain the cover need and quantified shortfall.',
        order: 10,
        required: true,
      },
      {
        ...
        purpose: 'Describe recommended cover, provider and premium.',
        order: 20,
        required: true,
      },
      {
  ...
  contract({
    ...
    description:
      'Recommends a new investment based on objectives, time horizon, risk profile, costs and suitability.',
  ...
  contract({
    ...
    description:
      'Documents replacement or transfer of an existing investment, including costs, benefits and disadvantages.',
    category: 'Investments',
  ...
  contract({
    ...
    description:
      'Recommends a new retirement product or contribution strategy based on retirement objectives.',
    category: 'Retirement',
    ...
    documentSections: [
      ...
      },
      {
        ...
        purpose: 'Disclose tax treatment, Regulation 28, fees and risk.',
        order: 30,
        required: true,
      },
    ],
  ...
  contract({
    ...
    description:
      'Documents a Section 14 retirement fund transfer, including ceding and receiving funds, costs and process.',
    category: 'Retirement',
    ...
    documentSections: [
      ...
      },
      {
        ...
        purpose: 'Explain receiving fund and investment strategy.',
        order: 20,
        required: true,
      },
      {

 ...
 * />
 */
export function WelcomeMessage({ content, features }: WelcomeMessageProps = {}) {
      ...
      {content ? (
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900">Ask Vasco</h3>
            <p className="text-sm text-muted-foreground max-w-md mx-auto">
              Your AI-powered advisory assistant. Ask about client finances, regulations, or
              products.
            </p>
          </div>

    ...
    try {
      ...
      if (!existing) {
        await communicationApi.createTemplate({
          ...
          bodyHtml:
            '<p>This is a reminder for the task <strong>{{task_title}}</strong>.</p><p>Please check the admin panel for more details.</p>',
          ...
          <div className="flex-1 overflow-y-auto flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-6 md:p-8 space-y-8 bg-white">
              ...
              <div className="flex items-start gap-4">
                <div className="mt-2 text-gray-500 shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {mode === 'create' || isTitleEditing ? (
                    <Input
                      ...
                      onBlur={() => {
                        if (mode !== 'create') setIsTitleEditing(false);
                      }}
                  ...
                  <div className="text-sm text-gray-500 mt-2 flex items-center gap-1">
                    ...
                    <span className="font-medium text-gray-900">
                      {STATUS_LABELS[formData.status as TaskStatus] || formData.status}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    {formData.assignee_initials ? (
                      <div
                        className="w-8 h-8 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold text-xs border border-purple-200"
                        title="Assignee"
                      >
                        {formData.assignee_initials}
                      </div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, assignee_initials: e.target.value })
                      }
            ...
            <div className="w-full md:w-[240px] bg-gray-50 p-6 space-y-6 border-t md:border-l md:border-t-0 border-gray-200">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-3 space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      setFormData({
                        ...formData,
                        reminder_frequency: val === 'none' ? null : (val as ReminderFrequency),
                      })
                    }
                  >
                    <SelectTrigger className="h-8 text-xs w-full">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full justify-start gap-2 h-9 text-red-600 hover:text-red-700 hover:bg-red-50 border-red-200"
                >

    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        {!loading && result && (
          <div className="space-y-4">
            ...
            {result.matches.length === 0 ? (
              <Alert>
                <AlertDescription>
                  No mappable client data was found for this form. You can continue entering details manually.
                </AlertDescription>
              </Alert>
            ) : (
              <>
            ...
            {result.unmatchedFormFields.length > 0 && (
              <Alert>
                <AlertDescription>
                  Unmatched fields: {result.unmatchedFormFields.join(', ')}
                </AlertDescription>
              </Alert>
            )}
          </div>
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          ...
          <Button type="button" onClick={handleApply} disabled={loading || !result || selected.size === 0}>

...
export function calculateLifeCover(input: InformationGatheringInput): LifeCoverCalculation {
  ...
  if (numDependants === 0) {
    ...
    incomeMultiple =
      baseMultiple + (numDependants - 1) * LIFE_COVER.MULTIPLES.ADDITIONAL_PER_DEPENDANT;
  }
 ...
 */
export function calculateDisabilityCover(
 ...
 */
export function calculateSevereIllnessCover(
  input: InformationGatheringInput,
): SevereIllnessCoverCalculation {

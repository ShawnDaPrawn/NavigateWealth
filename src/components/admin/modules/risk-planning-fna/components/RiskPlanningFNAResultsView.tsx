            ...
            <div className="contents">
              ...
              <div className="p-3 bg-muted/50 rounded-md space-y-2 text-sm">
                ...
                <p className="text-xs text-muted-foreground">
                  Overridden by {need.advisorOverride!.overriddenBy} on{' '}
                  {new Date(need.advisorOverride!.overriddenAt).toLocaleString()}
                </p>
              </div>
            </div>
          )}
              ...
              return (
                <div key={need.riskType} className="flex justify-between items-center text-sm">
                  ...
                  <div className="flex gap-4">
                    <span>
                      Personal: {formatCurrency(need.existingCoverPersonal || 0)}
                      {isMonthly && '/mo'}
                    </span>
                    <span>
                      Group: {formatCurrency(need.existingCoverGroup || 0)}
                      {isMonthly && '/mo'}
                    </span>

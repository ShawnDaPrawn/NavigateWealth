  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="md:col-span-1">
              ...
              <Select value="Mr" disabled>
                <SelectTrigger className="mt-1 opacity-75 h-9 text-xs">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {TITLES.map((t) => (
      ...
      <div>
        <PreviewSectionHeader
          icon={Fingerprint}
          title="Identification & Personal Information"
          description="Required for FICA compliance"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                value="1985-03-15"
                readOnly
                className="mt-1 opacity-75 h-9 text-xs"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4 mt-2">
                <span className="text-xs text-gray-500 flex items-center gap-1.5">
                  <span className="w-3.5 h-3.5 rounded-full border-2 border-[#6d28d9] flex items-center justify-center">
      ...
      <div>
        <PreviewSectionHeader
          ...
          description="Your marital regime affects estate and financial planning"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
    ...
    <div className="space-y-6">
      ...
      <div>
        <PreviewSectionHeader
          ...
          description="Help us reach you at the right time, in the right way"
        />
      ...
      <div>
        <PreviewSectionHeader
          ...
          description="Your physical address for FICA purposes"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4 space-y-3">
          <div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4">
          ...
          <Select value="employed" disabled>
            <SelectTrigger className="mt-1 opacity-75 h-9 text-xs max-w-md">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
      ...
      <div>
        <PreviewSectionHeader
          ...
          description="A rough estimate helps your advisor prepare"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
          ...
          <p className="text-[10px] text-gray-400 mt-2">
            These ranges help your advisor prepare for your first meeting.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div>
        <PreviewSectionHeader
          ...
          description="Select all the areas where you'd like guidance"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4">
            ...
            {ACCOUNT_REASON_OPTIONS.map((reason) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-xs ${isSelected ? 'font-medium text-gray-900' : 'text-gray-600'}`}
                  >
                    {reason}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {URGENCY_OPTIONS.map((option) => {
              ...
              return (
                <div
                  key={option.value}
                  className={`p-3 rounded-lg border-2 ${isSelected ? 'bg-[#6d28d9]/5 border-[#6d28d9]/30' : 'bg-white border-gray-100'}`}
                >
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-3.5 w-3.5 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${isSelected ? 'border-[#6d28d9]' : 'border-gray-300'}`}
                    >
                      {isSelected && <div className="h-1.5 w-1.5 rounded-full bg-[#6d28d9]" />}
                    </div>
                    <div>
                      <div
                        className={`text-xs font-medium ${isSelected ? 'text-gray-900' : 'text-gray-600'}`}
                      >
                        {option.label}
                      </div>
      ...
      <div>
        <PreviewSectionHeader
          icon={Package}
          title="Existing Financial Products"
        ...
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1.5">
            {EXISTING_PRODUCTS.map((p) => (
              <div
                key={p}
                className="flex items-center gap-2 p-2 rounded bg-[#6d28d9]/5 border border-[#6d28d9]/20"
              >
    ...
    <div className="space-y-6">
          ...
          {[
            {
              ...
              desc: "By creating an account, you agree to Navigate Wealth's Terms of Service and Privacy Policy.",
            },
            {
              icon: Shield,
              label: 'POPIA Consent *',
              desc: 'I consent to the processing of my personal information in accordance with POPIA.',
            },
            {
              icon: CheckCircle,
              label: 'Disclosure Acknowledgment *',
              desc: 'I acknowledge that I have read and understood the disclosure documents provided.',
            },
            {
              icon: Scale,
              label: 'FAIS Disclosure *',
              desc: 'I acknowledge that Navigate Wealth is an authorised financial services provider under FAIS.',
            },
          ].map((item, idx) => (
            <div
              key={idx}
      ...
      <div>
        <PreviewSectionHeader
          ...
          description="Type your full legal name to confirm this application"
        />
        <div className="bg-gray-50/60 border border-gray-100 rounded-lg p-4">
          ...
          <Input
            ...
            className="mt-1 opacity-75 h-9 text-xs italic"
          />
          <p className="text-[10px] text-gray-400 mt-1.5">
            By typing your name and submitting, you confirm all information is true and accurate.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="px-6 pt-6 pb-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-white flex-shrink-0">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm">
              This is a read-only preview of the enhanced application form that prospective clients
              complete when onboarding with Navigate Wealth.
            </DialogDescription>
          </DialogHeader>
          <Badge
            variant="outline"
            className="mt-3 text-xs font-medium border-purple-200 text-purple-700 bg-purple-50"
          >
                  ...
                  <div className="lg:hidden mb-4">
                    <Card className="p-3 shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge className="bg-[#6d28d9] hover:bg-[#6d28d9] text-xs">
                          {Math.round(progress)}%
                        </Badge>
                      </div>
                      <Progress value={progress} className="h-1.5" />

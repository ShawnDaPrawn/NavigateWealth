    ...
    <div className="space-y-8">
      <div className="text-center py-6">
        ...
        <p className="text-slate-500 mt-2 max-w-md mx-auto">
          Review generated recommendations. Select the ones you want to include in the Record of
          Advice.
        </p>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-green-600">
                  - {formatMoney(finalResults.medicalTaxCredits)}
                </span>
              </div>
              <div className="flex justify-between text-sm">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Optional notes to accompany this tax planning record. These are visible to the client in
            the published report.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <Label htmlFor="adviser-notes" className="sr-only">
              Adviser Notes
            </Label>
            <Textarea
              id="adviser-notes"

  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>Overview of system-wide activity metrics</CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    {activity.growth !== 0 && (
                      <span
                        className={`text-xs font-medium px-2 py-0.5 rounded-full bg-white/60 ${
                          activity.growth > 0 ? 'text-green-700' : 'text-red-700'
                        }`}
                      >
                        {activity.growth > 0 ? '+' : ''}
                        {Math.round(activity.growth)}%
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="text-sm opacity-80 font-medium truncate">{activity.label}</div>
                  </div>

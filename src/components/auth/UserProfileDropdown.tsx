      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <div className="hidden md:flex flex-col items-start">
            ...
            {isAdmin && <span className="text-xs text-[#6d28d9] font-medium">Administrator</span>}
          </div>
        ...
        <DropdownMenuLabel className="font-normal pb-3">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col space-y-1 flex-1">
              <p className="font-semibold leading-none text-gray-900">{getUserDisplayName()}</p>
            ...
            {isAdmin && (
              <div className="contents">
                ...
                <DropdownMenuItem asChild>
                  <Link
                    to="/admin"
                    className="cursor-pointer text-[#6d28d9] focus:text-[#6d28d9] focus:bg-purple-50"
                  >

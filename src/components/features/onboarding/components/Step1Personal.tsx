    ...
    <div className="space-y-10">
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div>
              <Label htmlFor="middleName" className={LABEL_CLASS}>
                Middle Name(s)
              </Label>
              <Input
                id="middleName"
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              >
                <label
                  htmlFor="taxResYes"
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg border border-gray-300 bg-white shadow-sm cursor-pointer hover:border-[#6d28d9]/40 transition-colors has-[*[data-state=checked]]:border-[#6d28d9] has-[*[data-state=checked]]:bg-[#6d28d9]/5 has-[*[data-state=checked]]:shadow-md"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="taxNumber" className={LABEL_CLASS}>
                Tax Number
              </Label>
              <Input
                id="taxNumber"
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => updateData('numberOfDependants', value)}
              >
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_SPACED_CLASS}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <Label htmlFor="maritalStatus" className={LABEL_CLASS}>
            ...
            {showSpouseFields && (
              <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateData('maritalRegime', value)}
                >
            ...
            <div className="animate-in fade-in duration-300 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-xs text-blue-800 leading-relaxed">
                {data.maritalRegime === 'In Community of Property' && (
                  <span>
                    <strong>In Community of Property:</strong> All assets and liabilities are
                    jointly owned. This has significant implications for estate planning and
                    creditor protection.
                  </span>
                )}
                {data.maritalRegime === 'Out of Community of Property (with accrual)' && (
                  <span>
                    <strong>ANC with Accrual:</strong> Separate estates during the marriage, with
                    accrual sharing at dissolution. Each spouse keeps what they brought in, but
                    growth is shared.
                  </span>
                )}
                {data.maritalRegime === 'Out of Community of Property (without accrual)' && (
                  <span>
                    <strong>ANC without Accrual:</strong> Complete separation of estates. Each
                    spouse&apos;s assets and debts remain their own throughout the marriage.
                  </span>
                )}
              </p>
            </div>
            ...
            <div className="animate-in fade-in slide-in-from-top-4 duration-300 pt-5 border-t border-gray-200">
              <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-5">
                ...
                <span className="ml-2 text-gray-400 font-normal normal-case tracking-normal">
                  (helps us prepare for your first meeting)
                </span>
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <Label htmlFor="spouseFirstName" className={LABEL_CLASS}>
                    Spouse First Name
                  </Label>
                  <Input
                    id="spouseFirstName"
                ...
                <div>
                  <Label htmlFor="spouseLastName" className={LABEL_CLASS}>
                    Spouse Last Name
                  </Label>
                  <Input
                    id="spouseLastName"
                ...
                <div>
                  <Label htmlFor="spouseDateOfBirth" className={LABEL_CLASS}>
                ...
                <div>
                  <Label htmlFor="spouseEmployed" className={LABEL_CLASS}>
                    Spouse Employment Status
                  </Label>
                  <Select
                    value={data.spouseEmployed}
                    onValueChange={(value) => updateData('spouseEmployed', value)}
                  >

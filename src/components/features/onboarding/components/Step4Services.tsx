...
import { INPUT_CLASS, LABEL_CLASS, SECTION_CONTAINER_CLASS } from '../form-styles';
    ...
    <div className="space-y-10">
      ...
      <div>
        ...
        <div className={SECTION_CONTAINER_CLASS}>
          <p className="text-sm text-gray-600 mb-5 font-medium">
            Please select all that apply <span className="text-red-500">*</span>
          </p>
          ...
          {data.accountReasons.includes('Other') && (
            <div className="mt-5 animate-in fade-in slide-in-from-top-2 duration-200">
              <Label htmlFor="otherReason" className={LABEL_CLASS}>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div
                      className={`h-4.5 w-4.5 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
      ...
      <div>
        <SectionHeader
          ...
          description="Do you currently have any of the following? This helps us understand your starting point."
        />
        <div className={SECTION_CONTAINER_CLASS}>
                  ...
                  className={`flex items-center gap-2.5 p-3.5 rounded-lg cursor-pointer transition-all ${
                    isSelected
                      ? isNone
                        ...
                        : 'bg-[#6d28d9]/5 border border-[#6d28d9]/30'
            ...
            <div className="mt-6 pt-5 border-t border-gray-200 animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-sm font-semibold text-gray-800">
                  Which providers are these with?
                </p>
              </div>
              <p className="text-xs text-gray-500 mb-4">
                Knowing your current providers helps your adviser assess your portfolio
                holistically. Leave blank if you're unsure.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {selectedRealProducts.map((product) => (
                  <div key={product}>
                    <Label
                      htmlFor={`provider-${product}`}
